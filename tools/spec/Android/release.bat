...
rmdir /s/q "%RELEASE_PATH%\%PROJ_DIR_NAME%\assets\res" >nul 2>nul
call "%ZF_TOOLS_PATH%\spec\Android\res_copy.bat" %PROJ_NAME% %PROJ_DIR_NAME% "%ZF_ROOT_PATH%\%PROJ_DIR_NAME%\res" "%RELEASE_PATH%\%PROJ_DIR_NAME%\assets\res" >nul 2>nul
