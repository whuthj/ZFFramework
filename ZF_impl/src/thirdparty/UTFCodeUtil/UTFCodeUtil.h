...
namespace UTFCodeUtil {
     ...
     */
    extern size_t UTF8GetWordCount(const char *src);

    /**
     * @brief convert UTF16 to UTF8
     */
    extern char *UTF16ToUTF8(const wchar_t *src);
    /**
     * @brief convert UTF8 to UTF16
     *
     * use space if letter out of UTF16's range
     */
    extern wchar_t *UTF8ToUTF16(const char *src);

    /**
     * @brief convert UTF16 to UTF16 big endian
     */
    extern wchar_t *UTF16ToUTF16BE(const wchar_t *src);
    /**
     * @brief convert UTF16 big endian to UTF16
     */
    extern wchar_t *UTF16BEToUTF16(const wchar_t *src);
