 ...
 */
extern bool JNIInit(JavaVM *javaVM, jint version = JNI_VERSION_1_1);

/**
 * @brief global java vm
 */
extern JavaVM *JNIGetJavaVM(void);

/**
 * @brief get desired version passed from JNIInit, or -1 if init failed
 */
extern jint JNIGetDesiredVersion(void);

/**
 * @brief get JNIEnv for current thread
 */
extern JNIEnv *JNIGetJNIEnv(void);
 ...
 */
extern void JNIConvertClassNameToClassSig(std::string &ret, const char *className);
 ...
 */
extern void JNIConvertClassNameFromClassSig(std::string &ret, const char *classSig);
 ...
 * class name can be get by SomeClass.class.getName() in your jave code
 */
extern void JNIConvertClassNameForFindClass(std::string &ret, const char *className);
 ...
 * @endcode
 */
extern std::string JNIGetMethodSig(const JNIType &returnType,
