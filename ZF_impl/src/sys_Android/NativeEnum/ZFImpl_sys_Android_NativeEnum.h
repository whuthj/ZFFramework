...
#define ZFImpl_sys_Android_JNI_ID_NativeEnum(clsId) ZFMACRO_CAT(ZFMACRO_CAT(ZFMACRO_CAT(ZFImpl_sys_Android_ROOT_JNI_ID, _), NativeEnum_), clsId)
#define ZFImpl_sys_Android_JNI_NAME_NativeEnum(clsName) ZFImpl_sys_Android_ROOT_JNI_NAME ".NativeEnum." ZFMACRO_TOSTRING_A(clsName)
