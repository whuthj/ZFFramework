...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFFilePathImpl_sys_Android, ZFFilePath, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Android:FileSystem"))
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFFilePathImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFFilePathImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
