...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFSemaphoreImpl_sys_Android, ZFSemaphore, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Android:Object_Semaphore"))
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFSemaphoreImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFSemaphoreImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
