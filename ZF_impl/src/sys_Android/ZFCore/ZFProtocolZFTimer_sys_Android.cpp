...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFTimerImpl_sys_Android, ZFTimer, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Android:Object_Timer"))

public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFTimerImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFTimerImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
