...
// ============================================================
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFThreadImpl_sys_Android, ZFThread, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Android:Thread"))
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFThreadImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFThreadImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
