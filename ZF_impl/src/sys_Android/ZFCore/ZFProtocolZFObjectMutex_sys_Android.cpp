...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFObjectMutexImpl_sys_Android, ZFObjectMutex, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Android:ReentrantLock"))

public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFObjectMutexImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFObjectMutexImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
