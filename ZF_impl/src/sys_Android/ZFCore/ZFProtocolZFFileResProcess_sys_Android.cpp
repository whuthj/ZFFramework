...
// need -landroid
// all resource files are located under "project_dir/assets/res/"
//
...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFFileResProcessImpl_sys_Android, ZFFileResProcess, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Android:AssetsFile"))
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFFileResProcessImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFFileResProcessImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
...
public:
    ...
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
        static jmethodID jmId = JNIUtilGetStaticMethodID(jniEnv, this->jclsOwner, zfTextA("native_ZFUIView_nativeViewScaleForImpl"),
