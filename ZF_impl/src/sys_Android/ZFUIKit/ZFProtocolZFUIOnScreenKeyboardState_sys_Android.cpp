...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIOnScreenKeyboardStateImpl_sys_Android, ZFUIOnScreenKeyboardState, ZFProtocolLevelSystemNormal)
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIOnScreenKeyboardStateImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIOnScreenKeyboardStateImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
