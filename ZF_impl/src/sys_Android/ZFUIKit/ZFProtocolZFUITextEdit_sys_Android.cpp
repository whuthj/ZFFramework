...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUITextEditImpl_sys_Android, ZFUITextEdit, ZFProtocolLevelSystemNormal)
...
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUITextEditImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUITextEditImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
