...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFAnimationNativeViewImpl_sys_Android, ZFAnimationNativeView, ZFProtocolLevelSystemNormal)
...
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFAnimationNativeViewImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFAnimationNativeViewImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
