...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIImageImpl_sys_Android, ZFUIImage, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Android:BitmapDrawable"))
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIImageImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIImageImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
