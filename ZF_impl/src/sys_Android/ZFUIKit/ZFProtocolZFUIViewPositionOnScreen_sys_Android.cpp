...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIViewPositionOnScreenImpl_sys_Android, ZFUIViewPositionOnScreen, ZFProtocolLevelSystemNormal)
...
public:
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIViewPositionOnScreenImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
