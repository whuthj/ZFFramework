...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIImageViewImpl_sys_Android, ZFUIImageView, ZFProtocolLevelSystemNormal)
...
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIImageViewImpl_sys_Android)(void)
    {
    ...
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIImageViewImpl_sys_Android)(void)
    {
        JNIEnv *jniEnv = JNIGetJNIEnv();
