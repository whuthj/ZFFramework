 ...
 */
extern void ZFImpl_sys_iOS_zfstringFromNSString(ZF_IN_OUT zfstring &result, ZF_IN NSString *nativeString);
/**
 * @brief convert NSString to zfstring, appended to result, do nothing if error
 */
 ...
 */
extern NSString *ZFImpl_sys_iOS_zfstringToNSString(ZF_IN const zfchar *s);

// ============================================================
/**
 * @brief return a string describe the object, for debug use only
 */
extern NSString *ZFImpl_sys_iOS_objectInfoNative(ZF_IN id nativeObject,
                                                ZF_IN_OPT NSArray *ignorePropertyNames = nil);
/**
 * @brief return a string describe the object, for debug use only
 */
extern zfstring ZFImpl_sys_iOS_objectInfo(ZF_IN id nativeObject,
