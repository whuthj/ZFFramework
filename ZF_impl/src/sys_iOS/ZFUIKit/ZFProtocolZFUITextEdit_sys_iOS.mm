...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUITextEditImpl_sys_iOS, ZFUITextEdit, ZFProtocolLevelSystemNormal)
...
public:
    virtual void *nativeTextEditCreate(ZF_IN ZFUITextEdit *textEdit)
    {
        ...
        return nativeImplView;
    }
    virtual void nativeTextEditDestroy(ZF_IN ZFUITextEdit *textEdit,
                                       ZF_IN void *nativeTextEdit)
    {
        [ZFCastStatic(_ZFP_ZFUITextEditImpl_sys_iOS_TextEdit *, nativeTextEdit) release];
    }
...
public:
    ...
    {
        _ZFP_ZFUITextEditImpl_sys_iOS_TextEdit *nativeImplView = ZFCastStatic(_ZFP_ZFUITextEditImpl_sys_iOS_TextEdit *, textEdit->nativeImplView());
