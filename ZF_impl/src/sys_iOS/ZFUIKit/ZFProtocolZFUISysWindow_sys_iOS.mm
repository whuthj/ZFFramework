...
@property (nonatomic, readonly) ZFUIOrientationEnum windowOrientation;
...
@synthesize
    ...
    ownerZFUISysWindow,
    windowOrientation,
    windowOrientationFlags;
// ============================================================
- (void)_ZFP_updateLayout
{
    if(self.ownerZFUISysWindow != zfnull)
    {
        UIView *nativeRootView = ZFCastStatic(UIView *, self.ownerZFUISysWindow->rootView()->nativeView());
...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUISysWindowImpl_sys_iOS, ZFUISysWindow, ZFProtocolLevelSystemNormal)
...
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUISysWindowImpl_sys_iOS)(void)
    {
        this->_mainWindow = zfnull;
    }
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUISysWindowImpl_sys_iOS)(void)
    {
...
public:
    ...
    virtual void mainWindowOnCleanup(void)
    {
        if(this->_mainWindow != zfnull)
        {
            _ZFP_ZFUISysWindowImpl_sys_iOS_NativeWindow *nativeWindow = ZFCastStatic(_ZFP_ZFUISysWindowImpl_sys_iOS_NativeWindow *, this->_mainWindow->nativeWindow());
            nativeWindow.ownerZFUISysWindow = zfnull;
            [nativeWindow autorelease];
    ...
    {
        _ZFP_ZFUISysWindowImpl_sys_iOS_NativeWindow *nativeWindow = ZFCastStatic(_ZFP_ZFUISysWindowImpl_sys_iOS_NativeWindow *, window->nativeWindow());

        ZFUIView::nativeViewNotifyBeforeAdd(window->rootView(), nativeWindow.view);

        UIView *nativeRootView = ZFCastStatic(UIView *, window->rootView()->nativeView());
    ...
    virtual ZFUISysWindow *modalWindowShow(ZF_IN ZFUISysWindow *ownerWindow)
    {
        ...
        [ZFCastStatic(UIViewController *, ownerWindow->nativeWindow()) presentViewController:nativeModalWindow animated:YES completion:nil];
                                   ...
                                   ZF_IN ZFUISysWindow *windowToFinish)
    {
        ...
        [ZFCastStatic(UIViewController *, ownerWindow->nativeWindow()) dismissViewControllerAnimated:YES completion:nil];
    }
    ...
    {
        [((_ZFP_ZFUISysWindowImpl_sys_iOS_NativeWindow *)window->nativeWindow()) _ZFP_updateLayout];
    }

    virtual ZFUIOrientationEnum windowOrientation(ZF_IN ZFUISysWindow *window)
    {
        return ((_ZFP_ZFUISysWindowImpl_sys_iOS_NativeWindow *)window->nativeWindow()).windowOrientation;
    }
    virtual void windowOrientationFlagsSet(ZF_IN ZFUISysWindow *window,
                                           ZF_IN const ZFUIOrientationFlags &flags)
    {
        ((_ZFP_ZFUISysWindowImpl_sys_iOS_NativeWindow *)window->nativeWindow()).windowOrientationFlags = flags;
    }
