...
@synthesize
    ...
    _ZFP_scrollContentFrameOverrideFlag,
...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIScrollViewImpl_sys_iOS, ZFUIScrollView, ZFProtocolLevelSystemNormal)
...
public:
    ...
    {
        [ZFCastStatic(UIView *, nativeScrollView) release];
    }
...
public:
    ...
    {
        ZFCastStatic(_ZFP_ZFUIScrollViewImpl_sys_iOS_ScrollView *, scrollView->nativeImplView()).scrollEnabled = scrollEnable;
    }
    ...
    {
        _ZFP_ZFUIScrollViewImpl_sys_iOS_ScrollView *nativeScrollView = ZFCastStatic(_ZFP_ZFUIScrollViewImpl_sys_iOS_ScrollView *, scrollView->nativeImplView());
...
public:
    ...
    {
        _ZFP_ZFUIScrollViewImpl_sys_iOS_ScrollView *nativeScrollView = ZFCastStatic(_ZFP_ZFUIScrollViewImpl_sys_iOS_ScrollView *, parent->nativeImplView());
