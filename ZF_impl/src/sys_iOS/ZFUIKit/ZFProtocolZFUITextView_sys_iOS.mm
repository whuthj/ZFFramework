...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUITextViewImpl_sys_iOS, ZFUITextView, ZFProtocolLevelSystemNormal)
...
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUITextViewImpl_sys_iOS)(void)
    {
    }
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUITextViewImpl_sys_iOS)(void)
    {
    }
...
public:
    ...
    {
        return [_ZFP_ZFUITextViewImpl_sys_iOS_TextView new];
    }
    virtual void nativeTextViewDestroy(ZF_IN ZFUITextView *textView,
                                       ZF_IN void *nativeTextView)
    {
        [ZFCastStatic(_ZFP_ZFUITextViewImpl_sys_iOS_TextView *, nativeTextView) release];
    }
...
public:
                         ...
                         ZF_IN ZFString *text)
    {
        ...
        if(text != zfnull)
        {
            NSString *nativeString = ZFCastStatic(NSString *, text->nativeString());
...
public:
    ...
    {
        return ZFCastStatic(_ZFP_ZFUITextViewImpl_sys_iOS_TextView *, textView->nativeImplView()).textSize;
    }
