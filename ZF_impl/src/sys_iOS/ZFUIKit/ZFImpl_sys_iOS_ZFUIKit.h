...
// convert utility
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUIPointToCGPoint(ZF_OUT CGPoint &ret, ZF_IN const ZFUIPoint &point);
...
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUIPointFromCGPoint(ZF_OUT ZFUIPoint &ret, ZF_IN const CGPoint &cgPoint);
...
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUISizeToCGSize(ZF_OUT CGSize &ret, ZF_IN const ZFUISize &size);
...
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUISizeFromCGSize(ZF_OUT ZFUISize &ret, ZF_IN const CGSize &cgSize);
...
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUIRectToCGRect(ZF_OUT CGRect &ret, ZF_IN const ZFUIRect &rect);
...
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUIRectFromCGRect(ZF_OUT ZFUIRect &ret, ZF_IN const CGRect &cgRect);
...
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUIMarginToUIEdgeInsets(ZF_OUT UIEdgeInsets &ret, ZF_IN const ZFUIMargin &margin);
...
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUIMarginFromUIEdgeInsets(ZF_OUT ZFUIMargin &ret, ZF_IN const UIEdgeInsets &edgeInsets);
...
extern UIColor *ZFImpl_sys_iOS_ZFUIKit_ZFUIColorToUIColor(ZF_IN const ZFUIColor &color);
extern void ZFImpl_sys_iOS_ZFUIKit_ZFUIColorFromUIColor(ZF_OUT ZFUIColor &ret, ZF_IN UIColor *uiColor);
...
// ============================================================
// util method
extern zfbool ZFImpl_sys_iOS_ZFUIKit_UIColorToARGB(ZF_IN_OUT zfindex *pARGB, ZF_IN UIColor *color);

extern void ZFImpl_sys_iOS_ZFUIKit_UIColorGetInfo(ZF_OUT zfstring &ret, ZF_IN UIColor *color);
...
extern void ZFImpl_sys_iOS_ZFUIKit_UIViewGetViewTree(ZF_OUT zfstring &ret, ZF_IN UIView *view);
