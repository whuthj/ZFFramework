...
@property (nonatomic, retain) _ZFP_ZFAnimationNativeViewImpl_sys_iOS_AniDelegate *_nativeAniDelegate;
@property (nonatomic, retain) NSString *_nativeAniKey;
- (void)_nativeAniOnStart:(zfidentity)aniId;
- (void)_nativeAniOnStop:(zfidentity)aniId finished:(BOOL)finished;
@end

@interface _ZFP_ZFAnimationNativeViewImpl_sys_iOS_AniDelegate : NSObject
@property (nonatomic, assign) _ZFP_ZFAnimationNativeViewImpl_sys_iOS_Ani *owner;
@property (nonatomic, assign) zfidentity aniId;
@end
@implementation _ZFP_ZFAnimationNativeViewImpl_sys_iOS_AniDelegate
@synthesize owner, aniId;
...
@synthesize ownerAni;
@synthesize nativeAniScale;
@synthesize _nativeAniDelegate, _nativeAniKey;
- (instancetype)init
{
    self = [super init];
    if(self)
...
- (void)nativeAniStart
{
    UIView *aniTarget = ZFCastStatic(UIView *, ZFCastZFObjectUnchecked(ZFUIView *, self.ownerAni->aniTarget())->nativeView());
    ...
    self._nativeAniDelegate = [[_ZFP_ZFAnimationNativeViewImpl_sys_iOS_AniDelegate new] autorelease];
...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFAnimationNativeViewImpl_sys_iOS, ZFAnimationNativeView, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("iOS:CAAnimation"))
...
public:
    ...
    {
        [ZFCastStatic(NSObject *, nativeAni) release];
    }

    virtual void nativeAniStart(ZF_IN ZFAnimationNativeView *ani,
                                ZF_IN zffloat nativeAniScale)
    {
        _ZFP_ZFAnimationNativeViewImpl_sys_iOS_Ani *nativeAni = ZFCastStatic(_ZFP_ZFAnimationNativeViewImpl_sys_iOS_Ani *, ani->nativeAnimation());
