...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUISysWindowImpl_sys_Qt, ZFUISysWindow, ZFProtocolLevelSystemHigh)
...
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUISysWindowImpl_sys_Qt)(void)
    {
        this->_mainWindow = zfnull;
    }
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUISysWindowImpl_sys_Qt)(void)
    {
