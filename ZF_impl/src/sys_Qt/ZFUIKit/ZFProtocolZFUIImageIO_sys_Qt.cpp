...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIImageIOImpl_sys_Qt, ZFUIImageIO, ZFProtocolLevelSystemHigh)
...
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIImageIOImpl_sys_Qt)(void)
    {
    }
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIImageIOImpl_sys_Qt)(void)
    {
    }
