...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIImageImpl_sys_Qt, ZFUIImage, ZFProtocolLevelSystemHigh)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Qt:QImage"))
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIImageImpl_sys_Qt)(void)
    {
    }
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIImageImpl_sys_Qt)(void)
    {
    }
