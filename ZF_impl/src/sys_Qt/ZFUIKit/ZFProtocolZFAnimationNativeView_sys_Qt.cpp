...
public:
    ...
    {
        return (int)this->ownerZFAnimation->aniDuration();
    }
protected:
    virtual void updateCurrentTime(int currentTime)
    {
        ...
        {
            this->aniCurStep = this->aniCurve->progressUpdate((zffloat)currentTime / this->duration());
...
private:
    ...
    void aniCaptureAndStart(void)
    {
        ...
        this->aniTargetOffsetCached = this->aniTargetCenterOffset();
    ...
    void aniDoPaint(void)
    {
        ...
        painter.translate(this->aniTargetOffsetCached);
...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFAnimationNativeViewImpl_sys_Qt, ZFAnimationNativeView, ZFProtocolLevelSystemHigh)
