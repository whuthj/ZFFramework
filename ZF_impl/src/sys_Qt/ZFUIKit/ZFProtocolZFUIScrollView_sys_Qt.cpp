...
protected:
    bool eventFilter(QObject *obj, QEvent *event)
    {
        ...
        if(touchedFgView != zfnull)
        {
            ...
            _ZFP_ZFUIScrollViewImpl_sys_Qt_MouseEventTagAccess(eTmp)->forwardedFlag.insert(this);
...
public:
                                   ...
                                   ZF_IN zfbool forwardToChildScrollView)
    {
        ...
        while(parent != NULL)
        {
            if(qobject_cast<_ZFP_ZFUIScrollViewImpl_sys_Qt_ScrollView *>(parent) != NULL)
            {
                _ZFP_ZFUIScrollViewImpl_sys_Qt_MouseEventTagAccess(e)->forwardedFlag.insert(parent);
            }
...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIScrollViewImpl_sys_Qt, ZFUIScrollView, ZFProtocolLevelSystemHigh)
