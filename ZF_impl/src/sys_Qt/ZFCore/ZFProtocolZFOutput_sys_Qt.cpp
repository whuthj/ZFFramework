...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFOutputImpl_sys_Qt, ZFOutput, ZFProtocolLevelSystemHigh)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Qt:qDebug"))
public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFOutputImpl_sys_Qt)(void)
    {
    }
    virtual ~ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFOutputImpl_sys_Qt)(void)
    {
