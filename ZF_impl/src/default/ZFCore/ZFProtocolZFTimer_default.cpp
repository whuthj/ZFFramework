...
public:
    ZFLISTENER_MEMBER_DECLARE(threadCallback)
    {
    ...
    ZFLISTENER_MEMBER_DECLARE(mainThreadCallback)
    {
        zfidentity curId = ZFCastZFObjectUnchecked(ZFValue *, userData)->identityValue();
...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFTimerImpl_default, ZFTimer, ZFProtocolLevelDefault)
