...
public class ZFValueType {
    ...
    public static final int e_int8 = ZFValueType.native_e_int8();
    private native static int native_e_int8();
    public static final int e_unsignedInt8 = ZFValueType.native_e_unsignedInt8();
    private native static int native_e_unsignedInt8();
    public static final int e_int16 = ZFValueType.native_e_int16();
    private native static int native_e_int16();
    public static final int e_unsignedInt16 = ZFValueType.native_e_unsignedInt16();
    private native static int native_e_unsignedInt16();
    public static final int e_int32 = ZFValueType.native_e_int32();
    private native static int native_e_int32();
    public static final int e_unsignedInt32 = ZFValueType.native_e_unsignedInt32();
    private native static int native_e_unsignedInt32();
    public static final int e_int64 = ZFValueType.native_e_int64();
    private native static int native_e_int64();
    public static final int e_unsignedInt64 = ZFValueType.native_e_unsignedInt64();
    private native static int native_e_unsignedInt64();
