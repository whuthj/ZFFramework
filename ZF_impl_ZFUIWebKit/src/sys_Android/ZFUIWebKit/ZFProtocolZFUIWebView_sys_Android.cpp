...
ZFPROTOCOL_IMPLEMENTATION_BEGIN(ZFUIWebViewImpl_sys_Android, ZFUIWebView, ZFProtocolLevelSystemNormal)
    ZFPROTOCOL_IMPLEMENTATION_PLATFORM_HINT(zfText("Android:WebView"))

public:
    ZFPROTOCOL_IMPLEMENTATION_CLASS(ZFUIWebViewImpl_sys_Android)(void)
    {
