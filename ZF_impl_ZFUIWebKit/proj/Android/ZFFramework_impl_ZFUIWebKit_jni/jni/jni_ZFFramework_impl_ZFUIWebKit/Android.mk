...
ZF_MODULE_NAME          = ZFFramework_impl_ZFUIWebKit
...
ZF_INCLUDES             += $(LOCAL_PATH)/../../../../../_release/Android/ZF_impl/libs/ZF_impl/include
...
ZF_LOAD_STATIC_LIB      =
ZF_LOAD_SHARED_LIB      = ZFFramework ZFFramework_impl
...
LOCAL_SRC_FILES := ../../../../../_release/Android/ZF/libs/ZF/$(TARGET_ARCH_ABI)/libZFFramework.so
include $(PREBUILT_SHARED_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := ZFFramework_impl
LOCAL_SRC_FILES := ../../../../../_release/Android/ZF_impl/libs/ZF_impl/$(TARGET_ARCH_ABI)/libZFFramework_impl.so
include $(PREBUILT_SHARED_LIBRARY)
