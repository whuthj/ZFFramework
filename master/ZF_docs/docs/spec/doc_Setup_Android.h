 ...
 *   which located in libs/ZF/include\n
 *   for example:
 *   @code
 *     // in your Android.mk
 *     LOCAL_C_INCLUDES := path_to_ZFFramework_include
 *
 *     // link ZFFramework so files
 *     include $(CLEAR_VARS)
 *     LOCAL_MODULE : ZFFramework
 *     LOCAL_SRC_FILES : path_to_ZFFramework/$(TARGET_ARCH_ABI)/libZFFramework.so
 *     include $(PREBUILT_SHARED_LIBRARY)
 *
 *     // link ZFFramework implementation so files
 *     include $(CLEAR_VARS)
 *     LOCAL_MODULE : ZFFramework_impl
 *     LOCAL_SRC_FILES : path_to_ZFFramework_impl/$(TARGET_ARCH_ABI)/libZFFramework_impl.so
 *     include $(PREBUILT_SHARED_LIBRARY)
 *
 *     // link ZFFramework implementation so files
 *     include $(CLEAR_VARS)
 *     LOCAL_MODULE : ZFFramework_impl_ZFUIWebKit
 *     LOCAL_SRC_FILES : path_to_ZFFramework_impl_ZFUIWebKit/$(TARGET_ARCH_ABI)/libZFFramework_impl_ZFUIWebKit.so
 *     include $(PREBUILT_SHARED_LIBRARY)
 *   @endcode
 ...
 *     }
 *   @endcode
 * -# ensure all of your resource files put in "assets/res" directory of your Android project,
