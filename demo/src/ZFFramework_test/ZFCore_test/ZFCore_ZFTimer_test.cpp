...
ZFLISTENER_FUNCTION_DECLARE(_ZFP_ZFCore_ZFTimer_test_timerEvent)
{
...
#endif
        timer->observerAdd(ZFTimer::EventTimerOnActivate(), ZFCallbackForMethod(ZFMethodAccessFunction(_ZFP_ZFCore_ZFTimer_test_timerEvent)), this);
        timer->timerIntervalSet(300);
        timer->timerStart();
    }
};
