...
public:
    ...
    ZFPROPERTY_RETAIN_WITH_DEFAULT(ZFObject *, propertyRetainWithDefault,
                                   ZFPropertyNoInitValue, ZFPropertyDefaultValue(zfnull))

    ZFPROPERTY_RETAIN_WITH_DEFAULT(ZFObject *, propertyRetainCustomSetterWithDefault,
                                   ZFPropertyNoInitValue,
                                   ZFPropertyDefaultValue(zfnull))
    ZFPROPERTY_CUSTOM_SETTER_DECLARE(ZFObject *, propertyRetainCustomSetterWithDefault);
    ...
    ZFPROPERTY_ASSIGN_WITH_DEFAULT(zfstring, propertyAssignWithDefault,
                                   ZFPropertyNoInitValue, ZFPropertyDefaultValue(zfstring()))

    ZFPROPERTY_ASSIGN_WITH_DEFAULT(zfstring, propertyAssignCustomSetterWithDefault,
                                   ZFPropertyNoInitValue,
                                   ZFPropertyDefaultValue(zfstring()))
    ZFPROPERTY_CUSTOM_SETTER_DECLARE(zfstring, propertyAssignCustomSetterWithDefault);
...
ZFPROPERTY_CUSTOM_SETTER_DEFINE(_ZFP_ZFCore_ZFProperty_test_TestBase, ZFObject *, propertyRetainCustomSetterWithDefault)
{
    zfLogT() << newValue;
    this->propertyRetainCustomSetterWithDefaultSetInternal(newValue);
}
ZFPROPERTY_CUSTOM_SETTER_DEFINE(_ZFP_ZFCore_ZFProperty_test_TestBase, zfstring, propertyAssignCustomSetterWithDefault)
{
    zfLogT() << newValue;
    this->propertyAssignCustomSetterWithDefaultSetInternal(newValue);
}
...
protected:
    ...
    virtual void testCaseOnStart(void)
    {
        ...
        this->testCaseOutput(zfText("ZFProperty"));
        {
            ...
            p->classData()->methodForName(zfText("propertyAssignSet"))->executeClassMember<void, zfstring const &>(p, zfText("newValue"));
            zfLogT() << zfText("after:") << p->propertyAssign();
            zfLogT() << zfText("access by reflect:") << p->classData()->methodForName(zfText("propertyAssign"))->executeClassMember<zfstring const &>(p);
            ...
            p->propertyRetainWithDefaultSet();
            zfLogT() << p->propertyRetainWithDefault();

            p->propertyRetainCustomSetterWithDefaultSet();
            zfLogT() << p->propertyRetainCustomSetterWithDefault();
            ...
            p->propertyAssignWithDefaultSet();
            zfLogT() << p->propertyAssignWithDefault();

            p->propertyAssignCustomSetterWithDefaultSet();
            zfLogT() << p->propertyAssignCustomSetterWithDefault();
