...
protected:
    ...
    virtual void testCaseOnStart(void)
    {
        ...
        this->testCaseOutput(zfText("current timeValue: %s, used: %s"), _ZFP_ZFCore_ZFTime_test_printZFTimeValue(tCur2->timeValue()).cString(), _ZFP_ZFCore_ZFTime_test_printZFTimeValue(ZFTimeValueDec(tCur2->timeValue(), tCur1->timeValue())).cString());
