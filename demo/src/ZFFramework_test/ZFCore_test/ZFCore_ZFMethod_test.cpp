...
public:
    ZFMETHOD_MEMBER_DECLARE_0(void, methodNormal)
    {
        zfLogT();
    }
    ZFMETHOD_MEMBER_DECLARE_0(void, methodDefinedInCppFile);
    ZFMETHOD_MEMBER_DECLARE_0(void, methodStaticallyRegistered)
    {
        zfLogT();
    }
    ZFMETHOD_MEMBER_DECLARE_0(void, methodOverrided)
    {
        zfLogT();
    }
    ZFMETHOD_MEMBER_DECLARE_0(void, methodOverridedStaticallyRegisteredInBase)
    {
        zfLogT();
    }
    ZFMETHOD_MEMBER_DECLARE_0(void, methodOverridedStaticallyRegisteredInBaseAndChild)
    {
        zfLogT();
    }
    ...
    ZFMETHOD_MEMBER_DECLARE_0(zfstring &, methodReturnReference)
    {
        zfLogT();
        return this->s;
    }
    ZFMETHOD_MEMBER_DECLARE_1(void, methodParamIsReference
                              , zfstring &, param0
                              )
    {
        zfLogT();
    ...
    ZFMETHOD_MEMBER_DECLARE_2(void, methodFor2Param
                              , const zfchar *, param0
                              , const zfchar *, param1
                              )
    {
    ...
    ZFMETHOD_MEMBER_DECLARE_3(void, methodFor3Param
                              , const zfchar *, param0
                              , const zfchar *, param1
                              , const zfchar *, param2
                              )
    ...
    ZFMETHOD_MEMBER_DECLARE_4(void, methodFor4Param
                              , const zfchar *, param0
                              , const zfchar *, param1
                              , const zfchar *, param2
                              , const zfchar *, param3
...
ZFMETHOD_MEMBER_DEFINE_0(_ZFP_ZFCore_ZFMethod_test_TestBase, void, methodDefinedInCppFile)
{
    zfLogT();
}
...
public:
    ...
    ZFMETHOD_MEMBER_DECLARE_0(void, methodInChild)
    {
        zfLogT();
    }
};
...
protected:
    ...
    virtual void testCaseOnStart(void)
    {
        ...
        this->testCaseOutput(zfText("methodNormal: %s"),
                ZFMethodAccessClassMember(_ZFP_ZFCore_ZFMethod_test_TestBase, methodNormal)->objectInfo().cString());
        this->testCaseOutput(zfText("methodStatic: %s"),
                ZFMethodAccessClassMember(_ZFP_ZFCore_ZFMethod_test_TestBase, methodStatic)->objectInfo().cString());
        this->testCaseOutput(zfText("methodOverloaded(zfstringA): %s"),
                ZFMethodAccessClassMemberDetail(_ZFP_ZFCore_ZFMethod_test_TestBase, methodOverloaded, ZFMethodId(zfstringA))->objectInfo().cString());
        this->testCaseOutput(zfText("methodOverloaded(zfstringW): %s"),
                ZFMethodAccessClassMemberDetail(_ZFP_ZFCore_ZFMethod_test_TestBase, methodOverloaded, ZFMethodId(zfstringW))->objectInfo().cString());

        this->testCaseOutput(zfText("unlike reflected by ZFClass, ZFMethodAccessClassMember would comiple error if method not defined"));
#if 0 // this should not able to be compiled
        ZFMethodAccessClassMember(_ZFP_ZFCore_ZFMethod_test_TestBase, methodNotDefined);
#endif
        ...
        clsBase->methodForNameIgnoreParent(zfText("methodNormal"))->executeClassMember<void>(this->pBase);
        clsBase->methodForNameIgnoreParent(zfText("methodNormal"))->executeClassMember<void>(this->pChild);
        clsBase->methodForNameIgnoreParent(zfText("methodNormal"))->executeClassMember<void>(this->pBasePointToChild);
        ...
        clsChild->methodForName(zfText("methodNormal"))->executeClassMember<void>(this->pBase);
        clsChild->methodForName(zfText("methodNormal"))->executeClassMember<void>(this->pChild);
        clsChild->methodForName(zfText("methodNormal"))->executeClassMember<void>(this->pBasePointToChild);
        ...
        clsBase->methodForNameIgnoreParent(zfText("methodOverloaded"), zfText("zfstringA"))->executeClassMember<void, const zfstringA &>(this->pBase, mbsStr);
        clsBase->methodForNameIgnoreParent(zfText("methodOverloaded"), zfText("zfstringW"))->executeClassMember<void, const zfstringW &>(this->pBase, wcsStr);
        ...
        clsBase->methodForNameIgnoreParent(zfText("methodForDefaultParam"))->executeClassMember<void, const zfstring &>(this->pBase,
        ...
        clsBase->methodForNameIgnoreParent(zfText("methodStatic"))->executeClassStatic<void>();
        this->testCaseOutput(zfText("executeClassStatic(param...) is equal to executeClassMember(zfnull, param...)"));
        clsBase->methodForNameIgnoreParent(zfText("methodStatic"))->executeClassMember<void>((ZFObject *)zfnull);
        ...
        clsBase->methodForNameIgnoreParent(zfText("methodReturnReference"))->executeClassMember<zfstring &>(this->pBase) = zfText("newString");
        ...
        clsBase->methodForNameIgnoreParent(zfText("methodParamIsReference"))->executeClassMember<void, zfstring &>(this->pBase, paramReference);
        ...
        this->testCaseOutput(zfText("before: %s"), paramReference.cString()));
        clsBase->methodForNameIgnoreParent(zfText("methodParamIsReference"))->executeClassMember<void>(this->pBase, paramReference);
        this->testCaseOutput(zfText("after: %s"), paramReference.cString()));
#endif
