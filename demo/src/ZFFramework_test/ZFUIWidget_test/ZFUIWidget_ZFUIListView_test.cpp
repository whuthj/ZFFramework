...
public:
    ...
    {
        #if 1
            return this->listCellSizeHint() + zfmRand(100);
        #else
    ...
    virtual inline void listCellOnUpdate(ZF_IN zfindex atIndex,
                                         ZF_IN ZFUIListCell *cell)
    {
        zfsuperI(ZFUIListAdapter)::listCellOnUpdate(atIndex, cell);
        ...
        virtual inline zfautoObject listCellCacheOnAccess(ZF_IN zfindex index)
        {
            return this->listCellCacheDefaultAccess(zfnull);
        }
        virtual inline void listCellCacheOnRecycle(ZF_IN ZFUIListCell *cell)
        {
            this->listCellCacheDefaultRecycle(zfnull, cell);
        }
    #endif
};
...
protected:
    ...
    virtual void testCaseOnStart(void)
    {
        ...
        listView->listAdapterSet(this->listAdapter());
        {
            ...
            listView->listUpdater()->add(cellUpdater);
...
private:
                              ...
                              ZF_IN ZFUIListView *listView)
    {
        ...
        ZFUIKit_test_prepareSettingForNormalProperty(settings, listView, ZFUIOrientationEnum, ZFPropertyAccess(ZFUIListView, listOrientation), ZFCoreArrayPODCreate(ZFUIOrientationEnum, ZFUIOrientation::e_Top, ZFUIOrientation::e_Left, ZFUIOrientation::e_Right, ZFUIOrientation::e_Bottom));
        ZFUIKit_test_prepareSettingForNormalProperty(settings, listView, zfint, ZFPropertyAccess(ZFUIListView, listCellSizeHint), ZFCoreArrayPODCreate(zfint, 56, 100, 44));
...
#define _ZFP_ZFUIWidget_ZFUIListView_test_autoScrollSpeed 100
        ...
        { // scroll random cell to random position
            ...
            ZFLISTENER_LOCAL(buttonClickListener, {
                ...
                zfindex toIndex = zfmRand(listView->listAdapter()->listCellCount());
