...
ifeq ($(OS),Windows_NT)
    ...
    $(info $(shell call ..\..\..\..\..\tools\spec\Android\res_copy.bat ZF2048 ZF2048 ..\..\..\res assets\res >nul 2>nul))
    ...
    $(info $(shell sh ../../../../../tools/spec/Android/res_copy.sh ZF2048 ZF2048 ../../../res assets/res))
