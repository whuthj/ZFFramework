...
// ============================================================
// ZF2048UIBlockStyle
zfinterface ZF2048UIBlockStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZF2048UIBlockStyle, ZFUIImageViewStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZF2048UIBlockStyle, ZFUIImageViewStyle)

public:
    ZFPROPERTY_ASSIGN_WITH_INIT(ZF2048Value, blockValue,
                                ZFPropertyInitValue(0))
};
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZF2048UIBlockStyle, ZFUIImageViewStyle)
 ...
 */
zfclass ZF2048UIBlock : zfextends ZFUIImageView, zfimplements ZF2048UIBlockStyle, zfimplements ZFCacheable
{
    ZFOBJECT_DECLARE(ZF2048UIBlock, ZFUIImageView)
    ZFIMPLEMENTS_DECLARE(ZF2048UIBlockStyle)

    ZFPROPERTY_OVERRIDE_INIT_STEP_DECLARE_ASSIGN(ZF2048Value, blockValue)
    {
        propertyValue = 0;
    }
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, ZF2048Value, blockValue);
