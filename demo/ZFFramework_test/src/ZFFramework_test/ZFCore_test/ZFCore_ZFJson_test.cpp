...
zfclass ZFCore_ZFJson_test : zfextends ZFFramework_test_TestCase
{
    ZFOBJECT_DECLARE(ZFCore_ZFJson_test, ZFFramework_test_TestCase)
...
ZFOBJECT_REGISTER(ZFCore_ZFJson_test)
