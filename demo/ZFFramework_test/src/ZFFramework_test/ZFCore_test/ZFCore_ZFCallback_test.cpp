...
zfclass _ZFP_ZFCore_ZFCallback_test_Class : zfextends ZFObject
{
    ...
    ZFMETHOD_MEMBER_DECLARE_0(void, classMember)
    {
        zfLogT();
    }

    ZFMETHOD_MEMBER_DECLARE_DETAIL_0(public, ZFMethodIsStatic, ZFMethodNotVirtual, ZFMethodNotConst, void, classStaticMember, ZFMethodNoId)
    {
        zfLogT();
    }
};

ZFMETHOD_FUNCTION_DECLARE_0(void, _ZFP_ZFCore_ZFCallback_test_StaticFunction)
{
    zfLogT();
}
...
public:
    ...
    virtual ZFObject *objectOnInit(void)
    {
        ...
        this->callbackFunction = ZFCallbackForMethod(ZFMethodAccessFunction(_ZFP_ZFCore_ZFCallback_test_StaticFunction));
        return this;
    }
    zfoverride
