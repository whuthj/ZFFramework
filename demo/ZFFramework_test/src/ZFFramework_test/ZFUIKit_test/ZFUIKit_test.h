...
public:
    ...
    {
        zfsuper::objectOnInitFinish();
        this->buttonBackgroundStyle()->to<ZFUIViewStyle *>()->viewBackgroundColorSet(ZFUIColorGreen);
        this->buttonBackgroundStyle(ZFUIButtonState::e_Highlighted)->to<ZFUIViewStyle *>()->viewBackgroundColorSet(ZFUIColorBlue);
    }
};
...
protected:
    ...
    virtual void layoutOnLayoutPrepare(ZF_IN const ZFUIRect &bounds)
    {
        ...
        this->scrollBySpeed(this->scrollBySpeedCurrentSpeedX(), this->scrollBySpeedCurrentSpeedY());
    }
};
...
#define ZFUIKit_test_prepareSettingForNormalProperty(settings, obj, PropertyType, property, propertyValues_) \
    ...
    public: \
        ...
        { \
            ...
            ownerProperty->setterMethod()->executeClassMember<void, PropertyType const &>(ownerObj, this->propertyValues[index]); \
        } \
        virtual void stateOnSave(ZF_IN const ZFProperty *ownerProperty, \
                                 ZF_IN ZFObject *ownerObj) \
        { \
            this->_savedState = ownerProperty->getterMethod()->executeClassMember<PropertyType const &>(ownerObj); \
        } \
        virtual void stateOnRestore(ZF_IN const ZFProperty *ownerProperty, \
                                    ZF_IN ZFObject *ownerObj) \
        { \
            ownerProperty->setterMethod()->executeClassMember<void, PropertyType const &>(ownerObj, this->_savedState); \
        } \
    public: \
