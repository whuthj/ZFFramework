...
protected:
    ...
    virtual void testCaseOnStart(void)
    {
        ...
        param.replaceDatas.set(zfText("replace_exist"), ZFCorePointerForObject<zfstring *>(zfnew(zfstring, zfText("_replace_exist_"))));
        param.enableIfDatas.set(zfText("enableif_true"), ZFCorePointerForObject<zfbool *>(zfnew(zfbool, zftrue)));
