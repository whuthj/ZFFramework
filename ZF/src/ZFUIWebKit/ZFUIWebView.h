...
// ZFUIWebViewStyle
/**
 * @brief style for #ZFUIWebView
 */
zfinterface ZF_ENV_EXPORT ZFUIWebViewStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFUIWebViewStyle, ZFUIViewStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIWebViewStyle, ZFUIViewStyle)

    ZFPROPERTY_OVERRIDE_INIT_VALUE_ASSIGN(zfbool, viewFocusable, zftrue)
};
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIWebViewStyle, ZFUIViewStyle)
 ...
 * @brief web view
 */
zfclass ZF_ENV_EXPORT ZFUIWebView : zfextends ZFUIView, zfimplements ZFUIWebViewStyle
{
    ZFOBJECT_DECLARE(ZFUIWebView, ZFUIView)
    ZFIMPLEMENTS_DECLARE(ZFUIWebViewStyle)
