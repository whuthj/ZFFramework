 ...
 * ====================================================================== */
#include "ZFPrivate_ZFUIWebKit.hh"
...
// ============================================================
ZFSTYLE_DEFAULT_DEFINE(ZFUIWebViewStyle, ZFUIViewStyle)
...
ZF_GLOBAL_INITIALIZER_INIT_WITH_LEVEL(ZFUIWebViewIgnoreZFUIViewFocusAutoHighlight, ZFLevelZFFrameworkNormal)
{
    ZFUIViewFocusAutoHighlightFilter.classFilter.filterAdd(ZFUIWebView::ClassData());
}
ZF_GLOBAL_INITIALIZER_END(ZFUIWebViewIgnoreZFUIViewFocusAutoHighlight)
