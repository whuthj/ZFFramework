 ...
 *   when language changed (see #EventLangOnChange)
 *
...
#define ZFLANGAPPLY_IMPL(T_ZFObject, YourTypeName, T_action) \
    ...
    inline void zfLangApply##YourTypeName(ZF_IN T_ZFObject *obj, \
                                          ...
                                          ZF_IN_OPT ZFObject *userData = zfnull) \
    { \
        zfLangApply(ZFObjectToObject(obj), ZFMACRO_TOSTRING(YourTypeName), langKey, _ZFP_zfLangApplyImpl_##YourTypeName::_ZFP_action, userData); \
    } \
    /** @brief see #zfLangApplyCancel */ \
    inline void zfLangApplyCancel##YourTypeName(ZF_IN T_ZFObject *obj) \
    { \
        zfLangApplyCancel(ZFObjectToObject(obj), ZFMACRO_TOSTRING(YourTypeName)); \
    }

// ============================================================
/**
 * @brief auto apply localized string to propery when #EventLangOnChange
 */
