 ...
 *   when skin changed (see #EventSkinOnChange)
 *
...
#define ZFSKINAPPLY_IMPL(YourTypeName, T_action) \
    ...
    inline void zfSkinApply##YourTypeName(ZF_IN ZFStyleable *obj, \
                                          ...
                                          ZF_IN_OPT ZFObject *userData = zfnull) \
    { \
        zfSkinApply(obj, ZFMACRO_TOSTRING(YourTypeName), skinKey, _ZFP_zfSkinApplyImpl_##YourTypeName::_ZFP_action, userData); \
    } \
    /** @brief see #zfSkinApplyCancel */ \
    inline void zfSkinApplyCancel##YourTypeName(ZF_IN ZFStyleable *obj) \
    { \
        zfSkinApplyCancel(obj, ZFMACRO_TOSTRING(YourTypeName)); \
    }
