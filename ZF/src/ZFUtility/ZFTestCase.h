...
protected:
    ...
    virtual inline void testCaseOnOutput(ZF_IN const zfchar *info)
    {
        ...
        ZFGlobalEventCenter::instance()->observerNotifyWithCustomSender(this, ZFTestCase::EventTestCaseOnOutput(), holder);
    ...
    virtual inline void testCaseOnStart(void)
    {
        ...
        ZFGlobalEventCenter::instance()->observerNotifyWithCustomSender(this, ZFTestCase::EventTestCaseOnStart());
    }
    ...
    virtual inline void testCaseOnProgress(ZF_IN ZFObject *progress)
    {
        ...
        ZFGlobalEventCenter::instance()->observerNotifyWithCustomSender(this, ZFTestCase::EventTestCaseOnProgress(), progress);
    }
...
#define ZFTestCaseAssert(cond) \
    ZFTestCaseAssertWithMessage(cond, zfText("test failed: %s"), ZFMACRO_TOSTRING(cond))
/** @brief see #ZFTestCaseAssert */
#define ZFTestCaseAssertTrim(cond) \
    ZFTestCaseAssertTrimWithMessage(cond, zfText("test failed: %s"), ZFMACRO_TOSTRING(cond))
/** @brief see #ZFTestCaseAssert */
#define ZFTestCaseAssertDetail(cond, callerFile, callerFunction, callerLine) \
    ZFTestCaseAssertDetailWithMessage(cond, callerFile, callerFunction, callerLine, zfText("test failed: %s"), ZFMACRO_TOSTRING(cond))
