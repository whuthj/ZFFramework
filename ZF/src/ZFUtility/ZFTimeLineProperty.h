...
#define ZFTIMELINEPROPERTY_DECLARE_COMMON_DETAIL(ZFTimeLinePropertyClassName, Type, progressFunc) \
    ...
    protected: \
        ...
        { \
            ...
            this->ownerProperty()->setterMethod()->executeClassMember<void, Type const &>(ownerObj, \
        ...
        { \
            ...
            this->_savedState = this->ownerProperty()->getterMethod()->executeClassMember<Type const &>(ownerObj); \
        } \
        zfoverride \
        virtual void stateOnRestore(ZF_IN ZFObject *ownerObj) \
        { \
            zfsuper::stateOnRestore(ownerObj); \
            this->ownerProperty()->setterMethod()->executeClassMember<void, Type const &>(ownerObj, this->_savedState); \
        } \
    private: \
        Type _savedState; \
...
#define ZFTIMELINEPROPERTY_DECLARE_COMMON(Type) \
    ZFTIMELINEPROPERTY_DECLARE_COMMON_DETAIL(ZFMACRO_CAT(ZFTimeLineProperty_, Type), Type, { \
