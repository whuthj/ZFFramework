...
protected:
     ...
     * (ZFClassUtil::#allPropertyIsEqual)\n
 ...
 * serializable data:
 * @code
 *   <ZFOperationCacheMatchActionEnum value="value">
 *   </ZFOperationCacheMatchActionEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFOperationCacheMatchActionEnum zfText("ZFOperationCacheMatchActionEnum")
/**
 ...
 * serializable data:
 * @code
 *   <ZFOperationTaskDuplicateActionEnum value="value">
 *   </ZFOperationTaskDuplicateActionEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFOperationTaskDuplicateActionEnum zfText("ZFOperationTaskDuplicateActionEnum")
/**
