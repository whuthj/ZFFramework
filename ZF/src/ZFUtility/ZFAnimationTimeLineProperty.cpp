...
// ============================================================
// serialize
zfbool ZFAnimationTimeLineProperty::serializableOnSerializeCategoryFromData(ZF_IN const ZFSerializableData &ownerData,
...
zfbool ZFAnimationTimeLineProperty::serializableOnSerializeCategoryToData(ZF_IN_OUT ZFSerializableData &ownerData,
    ...
    else
    {
        ...
        if(mismatch)
        {
            ZFSerializableUtil::errorOccurred(outErrorHintToAppend,
                ...
                d->steps.objectInfoOfContent().cString(), ref->d->steps.objectInfoOfContent().cString());
            return zffalse;
        }
    }
