...
// ZFAnimationStyle
/**
 * @brief style for #ZFAnimation
 */
zfinterface ZF_ENV_EXPORT ZFAnimationStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFAnimationStyle, ZFStyleable)
    ZFSTYLE_DEFAULT_DECLARE(ZFAnimationStyle, ZFStyleable)
};
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFAnimationStyle, ZFStyleable)
 ...
 * @brief base class of all animation
 */
zfabstract ZF_ENV_EXPORT ZFAnimation : zfextends ZFStyleableObject, zfimplements ZFAnimationStyle
{
    ZFOBJECT_DECLARE_ABSTRACT(ZFAnimation, ZFStyleableObject)
    ZFIMPLEMENTS_DECLARE(ZFAnimationStyle)
