...
// ============================================================
// ZFUIListCellViewStyle
/**
 * @brief style for #ZFUIListCellView
 */
zfinterface ZF_ENV_EXPORT ZFUIListCellViewStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFUIListCellViewStyle, ZFUIViewStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIListCellViewStyle, ZFUIViewStyle)
};
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIListCellViewStyle, ZFUIViewStyle)
 ...
 * @brief abstract list content view
 */
zfabstract ZF_ENV_EXPORT ZFUIListCellView : zfextends ZFUIView, zfimplements ZFUIListCellViewStyle
{
    ZFOBJECT_DECLARE_ABSTRACT(ZFUIListCellView, ZFUIView)
    ZFIMPLEMENTS_DECLARE(ZFUIListCellViewStyle)
