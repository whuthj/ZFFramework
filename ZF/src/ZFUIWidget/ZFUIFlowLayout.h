...
// ZFUIFlowLayoutStyle
/**
 * @brief style for #ZFUIFlowLayout
 */
zfinterface ZF_ENV_EXPORT ZFUIFlowLayoutStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFUIFlowLayoutStyle, ZFUIViewStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIFlowLayoutStyle, ZFUIViewStyle)
...
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIFlowLayoutStyle, ZFUIViewStyle)
 ...
 */
zfclass ZF_ENV_EXPORT ZFUIFlowLayout : zfextends ZFUIView, zfimplements ZFUIFlowLayoutStyle
{
    ZFOBJECT_DECLARE(ZFUIFlowLayout, ZFUIView)
    ZFIMPLEMENTS_DECLARE(ZFUIFlowLayoutStyle)

public:
    // ============================================================
    // styles
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, ZFUIOrientationEnum, layoutOrientationMain);
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, ZFUIOrientationEnum, layoutOrientationSecondary);
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, ZFUIMargin, layoutChildMargin);
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, zfint, layoutChildSpaceX);
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, zfint, layoutChildSpaceY);
...
protected:
    ...
    zfoverride
    virtual void viewChildVisibleOnChange(void)
    {
        zfsuper::viewChildVisibleOnChange();
        this->layoutRequest();
    }
};
