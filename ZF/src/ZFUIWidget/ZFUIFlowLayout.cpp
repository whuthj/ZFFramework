...
ZFSTYLE_DEFAULT_DEFINE(ZFUIFlowLayoutStyle, ZFUIViewStyle)
...
ZFPROPERTY_OVERRIDE_SETTER_DEFINE(ZFUIFlowLayout, ZFUIOrientationEnum, layoutOrientationMain)
{
    zfbool changed = (this->layoutOrientationMain() != newValue);
    zfsuperI(ZFUIFlowLayoutStyle)::layoutOrientationMainSet(newValue);
    if(changed)
    {
        this->layoutRequest();
    }
}
ZFPROPERTY_OVERRIDE_SETTER_DEFINE(ZFUIFlowLayout, ZFUIOrientationEnum, layoutOrientationSecondary)
{
    zfbool changed = (this->layoutOrientationSecondary() != newValue);
    zfsuperI(ZFUIFlowLayoutStyle)::layoutOrientationSecondarySet(newValue);
    if(changed)
    {
        this->layoutRequest();
    }
}
ZFPROPERTY_OVERRIDE_SETTER_DEFINE(ZFUIFlowLayout, ZFUIMargin, layoutChildMargin)
{
    zfbool changed = (this->layoutChildMargin() != newValue);
    zfsuperI(ZFUIFlowLayoutStyle)::layoutChildMarginSet(newValue);
    if(changed)
    {
        this->layoutRequest();
    }
}
ZFPROPERTY_OVERRIDE_SETTER_DEFINE(ZFUIFlowLayout, zfint, layoutChildSpaceX)
{
    zfbool changed = (this->layoutChildSpaceX() != newValue);
    zfsuperI(ZFUIFlowLayoutStyle)::layoutChildSpaceXSet(newValue);
    if(changed)
    {
        this->layoutRequest();
    }
}
ZFPROPERTY_OVERRIDE_SETTER_DEFINE(ZFUIFlowLayout, zfint, layoutChildSpaceY)
{
    zfbool changed = (this->layoutChildSpaceY() != newValue);
    zfsuperI(ZFUIFlowLayoutStyle)::layoutChildSpaceYSet(newValue);
    if(changed)
    {
        this->layoutRequest();
    }
