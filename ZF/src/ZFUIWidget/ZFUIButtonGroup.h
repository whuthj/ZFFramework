 ...
 * serializable data:
 * @code
 *   <ZFUIButtonGroupTypeEnum value="value">
 *   </ZFUIButtonGroupTypeEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFUIButtonGroupTypeEnum zfText("ZFUIButtonGroupTypeEnum")
/**
...
public:
    ...
    ZFPROPERTY_ASSIGN_WITH_INIT(ZFUIButtonGroupTypeEnum, buttonGroupType,
                                ZFPropertyInitValue(ZFUIButtonGroupType::e_Default()))
