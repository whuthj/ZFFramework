...
// ZFUIListViewStyle
/**
 * @brief style for #ZFUIListView
 */
zfinterface ZF_ENV_EXPORT ZFUIListViewStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFUIListViewStyle, ZFUIScrollViewStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIListViewStyle, ZFUIScrollViewStyle)
...
public:
    ...
    /**
     * @brief list updater to update list cells
     */
    ZFPROPERTY_RETAIN_READONLY(ZFArrayEditable *, listUpdater, ZFPropertyInitValue(zflineAllocWithoutLeakTest(ZFArrayEditable)))
     ...
     */
    ZFPROPERTY_ASSIGN_WITH_INIT(zfint, listCellSizeHint,
                                ZFPropertyInitValue(ZFUIGlobalStyle::DefaultStyle()->itemSizeListCell()))

    /**
     * @brief whether auto update #ZFUIScrollViewStyle::scrollBounceVertical series accorrding to #listOrientation,
     *   true by default
     */
    ZFPROPERTY_ASSIGN_WITH_INIT(zfbool, listBounce, ZFPropertyInitValue(zftrue))
};
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIListViewStyle, ZFUIScrollViewStyle)
 ...
 */
zfclass ZF_ENV_EXPORT ZFUIListView : zfextends ZFUIScrollView, zfimplements ZFUIListViewStyle
{
    ZFOBJECT_DECLARE(ZFUIListView, ZFUIScrollView)
    ZFIMPLEMENTS_DECLARE(ZFUIListViewStyle)
...
public:
    // ============================================================
    // styles
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, ZFUIListAdapter *, listAdapter);
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, ZFUIOrientationEnum, listOrientation);
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, zfint, listCellSizeHint);
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, zfbool, listBounce);
...
protected:
    ...
    zfoverride
    virtual void scrollThumbMarginOnChange(void);
    zfoverride
...
protected:
    ...
    virtual inline void listCellOnAttach(ZF_IN ZFUIListCell *cell)
    {
        this->observerNotify(ZFUIListView::EventListCellOnAttach(), cell);
    }
    /** @brief see #EventListCellOnDetach */
    virtual inline void listCellOnDetach(ZF_IN ZFUIListCell *cell)
    {
