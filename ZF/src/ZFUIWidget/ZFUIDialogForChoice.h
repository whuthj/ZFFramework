 ...
 * serializable data:
 * @code
 *   <ZFUIDialogForChoiceModeEnum value="value">
 *   </ZFUIDialogForChoiceModeEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFUIDialogForChoiceModeEnum zfText("ZFUIDialogForChoiceModeEnum")
/**
...
// ============================================================
// ZFUIDialogForChoiceStyle
/**
 * @brief style for #ZFUIDialogForChoice
 */
zfinterface ZF_ENV_EXPORT ZFUIDialogForChoiceStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFUIDialogForChoiceStyle, ZFUIDialogBasicStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIDialogForChoiceStyle, ZFUIDialogBasicStyle)

    /**
     * @brief choice mode, #ZFUIDialogForChoiceMode::e_Default by default
     */
    ZFPROPERTY_ASSIGN_WITH_INIT(ZFUIDialogForChoiceModeEnum, choiceMode,
                                ZFPropertyInitValue(ZFUIDialogForChoiceMode::e_Default()))
...
protected:
     ...
     */
    virtual inline void choiceListOnChange(void)
    {
    }
    /**
     * @brief called when selected index list changed
     */
    virtual inline void choiceSelectedListOnChange(void)
    {
    }
...
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIDialogForChoiceStyle, ZFUIDialogBasicStyle)
...
zfclass ZF_ENV_EXPORT ZFUIDialogForChoice : zfextends ZFUIDialogBasic
                                          , zfimplements ZFUIDialogForChoiceStyle
{
    ZFOBJECT_DECLARE(ZFUIDialogForChoice, ZFUIDialogBasic)
    ZFIMPLEMENTS_DECLARE(ZFUIDialogForChoiceStyle)
