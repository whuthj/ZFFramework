...
protected:
    ...
    virtual inline void hintOnInit(void)
    {
        ...
        ZFGlobalEventCenter::instance()->observerNotifyWithCustomSender(this, ZFUIHint::EventHintOnInit());
    }
    /** @brief see #ZFUIHint::EventHintOnUpdate */
    virtual inline void hintOnUpdate(void)
    {
        this->observerNotify(ZFUIHint::EventHintOnUpdate());
        ZFGlobalEventCenter::instance()->observerNotifyWithCustomSender(this, ZFUIHint::EventHintOnUpdate());
    }
    /** @brief see #ZFUIHint::EventHintOnShow */
    virtual inline void hintOnShow(void)
    {
        this->observerNotify(ZFUIHint::EventHintOnShow());
        ZFGlobalEventCenter::instance()->observerNotifyWithCustomSender(this, ZFUIHint::EventHintOnShow());
    }
