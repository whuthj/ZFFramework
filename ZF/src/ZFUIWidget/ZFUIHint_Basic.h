...
/**
 * @brief style for #ZFUIHintContentBasic
 */
zfinterface ZF_ENV_EXPORT ZFUIHintContentBasicStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFUIHintContentBasicStyle, ZFUIButtonBasicStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIHintContentBasicStyle, ZFUIButtonBasicStyle)
    ...
    {
        ZFUITextViewStyle *value = propertyValue.to<ZFUITextViewStyle *>();
    ...
    {
        ZFUIImageViewStyle *value = propertyValue.to<ZFUIImageViewStyle *>();
        value->imageContentSet(ZFUIImageResXml(zfText("ZFFramework/ZFUIWidget/ZFUIHintContentBasic_background.xml")).to<ZFUIImage *>());
    }
};
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIHintContentBasicStyle, ZFUIButtonBasicStyle)

/**
 * @brief #ZFUIHint's content with simple text and background
 */
zfclass ZF_ENV_EXPORT ZFUIHintContentBasic : zfextends ZFUIButtonBasic, zfimplements ZFUIHintContentBasicStyle
{
