...
// ZFUIListCellStyle
/**
 * @brief style for #ZFUIListCell
 */
zfinterface ZF_ENV_EXPORT ZFUIListCellStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFUIListCellStyle, ZFUIViewStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIListCellStyle, ZFUIViewStyle)
};
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIListCellStyle, ZFUIViewStyle)
 ...
 */
zfclass ZF_ENV_EXPORT ZFUIListCell : zfextends ZFUIView, zfimplements ZFUIListCellStyle
{
    ZFOBJECT_DECLARE(ZFUIListCell, ZFUIView)
    ZFIMPLEMENTS_DECLARE(ZFUIListCellStyle)
