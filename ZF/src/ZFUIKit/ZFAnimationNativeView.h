 ...
 * serializable data:
 * @code
 *   <ZFAnimationNativeViewCurveEnum value="value">
 *   </ZFAnimationNativeViewCurveEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFAnimationNativeViewCurveEnum zfText("ZFAnimationNativeViewCurveEnum")
/**
