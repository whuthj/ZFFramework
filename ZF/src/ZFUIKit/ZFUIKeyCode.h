 ...
 * serializable data:
 * @code
 *   <ZFUIKeyActionEnum value="value">
 *   </ZFUIKeyActionEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFUIKeyActionEnum zfText("ZFUIKeyActionEnum")
/**
 ...
 * serializable data:
 * @code
 *   <ZFUIKeyCodeEnum value="value">
 *   </ZFUIKeyCodeEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFUIKeyCodeEnum zfText("ZFUIKeyCodeEnum")
/**
 * @brief key code
 */
