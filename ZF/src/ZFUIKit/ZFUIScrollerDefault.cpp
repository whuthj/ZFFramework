...
public:
    ZFUIScrollerDefault *ownerScroller;
...
public:
    ...
    {
        this->aniLastTime = this->ownerScroller->scrollAniStartCallback.execute();
    }
    void scrollAniNotifyStop(void)
    {
        ...
        this->ownerScroller->scrollAniStopCallback.execute();
    }
...
public:
    zfbool scrollAlignToPageCheckUpdate(void)
    {
        ...
        zfint endPos = this->ownerScroller->scrollEndPointPredicted();
        ...
        if(endPos != endPosAligned)
        {
            ...
            this->ownerScroller->scrollByPoint(endPosAligned);
