 ...
 * serializable data:
 * @code
 *   <ZFEnvDeviceUITypeEnum value="value">
 *   </ZFEnvDeviceUITypeEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFEnvDeviceUITypeEnum zfText("ZFEnvDeviceUITypeEnum")
/**
 ...
 */
extern ZF_ENV_EXPORT ZFEnvDeviceUITypeEnum deviceUIType(ZF_IN_OPT ZFEnvDeviceUITypeEnum defaultValue = ZFEnvDeviceUIType::e_Desktop);
