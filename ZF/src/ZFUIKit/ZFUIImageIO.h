...
/** @brief see #ZFUIImageSerializeTypeRegister */
#define ZFUIImageSerializeTypeName_input ZFMACRO_TOSTRING(ZFUIImageSerializeType_input)
...
/** @brief see #ZFUIImageSerializeTypeRegister */
#define ZFUIImageSerializeTypeName_color ZFMACRO_TOSTRING(ZFUIImageSerializeType_color)
