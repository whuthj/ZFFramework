 ...
 * serializable data:
 * @code
 *   <ZFUIWindowLevelEnum value="value">
 *   </ZFUIWindowLevelEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFUIWindowLevelEnum zfText("ZFUIWindowLevelEnum")
/**
...
// ZFUIWindowStyle
/**
 * @brief style for #ZFUIWindow
 */
zfinterface ZF_ENV_EXPORT ZFUIWindowStyle : zfextends ZFInterface
{
    ZFINTERFACE_DECLARE(ZFUIWindowStyle, ZFUIViewStyle)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIWindowStyle, ZFUIViewStyle)
...
public:
    ...
    ZFPROPERTY_ASSIGN_WITH_INIT(ZFUIWindowLevelEnum, windowLevel,
                                ZFPropertyInitValue(ZFUIWindowLevel::e_Default()))
};
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIWindowStyle, ZFUIViewStyle)
 ...
 */
zfclass ZF_ENV_EXPORT ZFUIWindow : zfextends ZFUIView, zfimplements ZFUIWindowStyle
{
    ZFOBJECT_DECLARE(ZFUIWindow, ZFUIView)
    ZFIMPLEMENTS_DECLARE(ZFUIWindowStyle)
...
public:
     ...
     * @note this event would only be fired to #ZFGlobalEventCenter,
     *   sender is the #windowLayoutParam,
     *   it's impossible to access owner window during this event
...
public:
    ...
    // ============================================================
    // properties
    ZFPROPERTY_OVERRIDE_SETTER_DECLARE(public, ZFUIWindowLevelEnum, windowLevel);
...
protected:
    ...
    virtual inline void windowOnShow(void)
    {
        ...
        ZFGlobalEventCenter::instance()->observerNotifyWithCustomSender(this, ZFUIWindow::EventWindowOnShow());
    }
    /** @brief see #EventWindowOnHide */
    virtual inline void windowOnHide(void)
    {
        this->observerNotify(ZFUIWindow::EventWindowOnHide());
        ZFGlobalEventCenter::instance()->observerNotifyWithCustomSender(this, ZFUIWindow::EventWindowOnHide());
    }
