...
{
    ZFINTERFACE_DECLARE(ZFUIGlobalStyle, ZFStyleable)
    ZFSTYLE_DEFAULT_DECLARE(ZFUIGlobalStyle, ZFStyleable)
...
ZFSTYLE_DEFAULT_HOLDER_DECLARE(ZFUIGlobalStyle, ZFStyleable)
