...
void _ZFP_ZFUIScrollViewImplHelperPrivate::resolveMouseDown(ZF_IN void *nativeMouseEvent)
{
    ...
    if(this->owner->scrollView->scrollViewState() != ZFUIScrollViewState::e_Idle)
    {
        ...
        ZFPROTOCOL_ACCESS(ZFUIScrollView)->notifyScrollViewDragBegin(this->owner->scrollView, ZFUIPointMake(x, y), this->owner->implProtocol->nativeTime());
        return ;
    }
...
void _ZFP_ZFUIScrollViewImplHelperPrivate::resolveMouseMove(ZF_IN void *nativeMouseEvent)
{
    ...
    {
        ZFPROTOCOL_ACCESS(ZFUIScrollView)->notifyScrollViewDrag(this->owner->scrollView, ZFUIPointMake(x, y), this->owner->implProtocol->nativeTime());
        return ;
    }
    ...
    else
    {
        ...
        this->mouseDownCleanup();
        ZFPROTOCOL_ACCESS(ZFUIScrollView)->notifyScrollViewDragBegin(this->owner->scrollView, ZFUIPointMake(xSaved, ySaved), this->owner->implProtocol->nativeTime());
        ZFPROTOCOL_ACCESS(ZFUIScrollView)->notifyScrollViewDrag(this->owner->scrollView, ZFUIPointMake(x, y), this->owner->implProtocol->nativeTime());
    }
}
void _ZFP_ZFUIScrollViewImplHelperPrivate::resolveMouseUp(ZF_IN void *nativeMouseEvent)
{
    ...
    if(this->dragState == _ZFP_ZFUIScrollViewImplHelperDragStateDragging)
    {
        ZFPROTOCOL_ACCESS(ZFUIScrollView)->notifyScrollViewDragEnd(this->owner->scrollView, this->owner->implProtocol->nativeTime(), zftrue);
        return ;
    }
    else if(this->dragState == _ZFP_ZFUIScrollViewImplHelperDragStateIgnored)
    {
...
void _ZFP_ZFUIScrollViewImplHelperPrivate::resolveMouseCancel(ZF_IN void *nativeMouseEvent)
{
    ...
    if(this->dragState == _ZFP_ZFUIScrollViewImplHelperDragStateDragging)
    {
        ZFPROTOCOL_ACCESS(ZFUIScrollView)->notifyScrollViewDragEnd(this->owner->scrollView, this->owner->implProtocol->nativeTime(), zffalse);
        return ;
    }
    else if(this->dragState == _ZFP_ZFUIScrollViewImplHelperDragStateIgnored)
    {
