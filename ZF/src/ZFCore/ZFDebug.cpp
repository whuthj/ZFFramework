...
public:
    ZFMETHOD_MEMBER_DECLARE_2(zfindex, onOutput, const void *, src, zfindex, count)
    {
...
// ============================================================
void ZFDebugLevelToString(ZF_IN_OUT zfstring &ret, ZF_IN ZFDebugLevel const &value)
{
    switch(value)
    {
        case ZFDebugLevelVerbose:
            ret += ZFTOKEN_ZFDebugLevelVerbose;
            return ;
        case ZFDebugLevelDebug:
            ret += ZFTOKEN_ZFDebugLevelDebug;
            return ;
        case ZFDebugLevelInfo:
            ret += ZFTOKEN_ZFDebugLevelInfo;
            return ;
        case ZFDebugLevelWarning:
            ret += ZFTOKEN_ZFDebugLevelWarning;
            return ;
        case ZFDebugLevelError:
            ret += ZFTOKEN_ZFDebugLevelError;
            return ;
        case ZFDebugLevelAssert:
            ret += ZFTOKEN_ZFDebugLevelAssert;
            return ;
        default:
...
const zfchar *ZFDebugLevelFromString(ZF_OUT ZFDebugLevel &ret,
                                     ZF_IN const zfchar *src,
                                     ZF_IN_OPT zfindex srcLen /* = zfindexMax */)
{
    const zfchar *tokens[] = {
        ZFTOKEN_ZFDebugLevelVerbose,
        ZFTOKEN_ZFDebugLevelDebug,
        ZFTOKEN_ZFDebugLevelInfo,
        ZFTOKEN_ZFDebugLevelWarning,
        ZFTOKEN_ZFDebugLevelError,
        ZFTOKEN_ZFDebugLevelAssert,
    };
    zfindex matched = ZFCoreStringCheckMatch(tokens, ZFMACRO_ARRAY_SIZE(tokens), src, srcLen);
    ret = ZFDebugLevelVerbose;
    switch(matched)
    {
        case 0:
            ret = ZFDebugLevelVerbose;
            return zfnull;
        case 1:
            ret = ZFDebugLevelDebug;
            return zfnull;
        case 2:
            ret = ZFDebugLevelInfo;
            return zfnull;
        case 3:
            ret = ZFDebugLevelWarning;
            return zfnull;
        case 4:
            ret = ZFDebugLevelError;
            return zfnull;
        case 5:
            ret = ZFDebugLevelAssert;
            return zfnull;
        default:
            return src;
    }
...
static zfbool _ZFP_ZFDebugLevelFromInput(ZF_OUT ZFDebugLevel &v, ZF_IN const ZFInputCallback &input)
{
    const zfchar *tokens[] = {
        ZFTOKEN_ZFDebugLevelVerbose,
        ZFTOKEN_ZFDebugLevelDebug,
    ...
    switch(matched)
    {
        ...
        case 2:
            ...
            return zftrue;
        case 3:
            v = ZFDebugLevelWarning;
            return zftrue;
        case 4:
            v = ZFDebugLevelError;
            return zftrue;
        case 5:
            v = ZFDebugLevelAssert;
            return zftrue;
        default:
            return zffalse;
    }
}
ZFINPUT_TYPE_DEFINE(ZFDebugLevel, ZFDebugLevel, {return _ZFP_ZFDebugLevelFromInput(v, input);})

// ============================================================
void zfDebugLevelSet(ZF_IN ZFDebugLevel level)
{
    zfDebugSessionLevelSet(_ZFP_ZFDebugGlobalSession, level);
}
ZFDebugLevel zfDebugLevelGet(void)
{
    return zfDebugSessionLevelGet(_ZFP_ZFDebugGlobalSession);
}
zfbool zfDebugIsActive(ZF_IN ZFDebugLevel level)
{
...
ZFDebugLevel zfDebugSessionLevelGet(ZF_IN_OUT ZFDebugSession &session)
{
