...
ZFInputCallback ZFIOBridgeCallbackUsingTmpFile::inputCallback(void)
{
    return (d->callbackIsValid()
        ? ZFCallbackForMemberMethod(d, ZFMethodAccessClassMember(_ZFP_ZFIOBridgeCallbackUsingTmpFilePrivate, onInput))
        : ZFCallbackNull());
}
ZFOutputCallback ZFIOBridgeCallbackUsingTmpFile::outputCallback(void)
{
    return (d->callbackIsValid()
        ? ZFCallbackForMemberMethod(d, ZFMethodAccessClassMember(_ZFP_ZFIOBridgeCallbackUsingTmpFilePrivate, onOutput))
        : ZFCallbackNull());
}
