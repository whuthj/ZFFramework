...
T_Str &_ZFP_zfstringAppendT(ZF_OUT T_Str &s,
                            ZF_IN const T_Char *fmt,
                            ZF_IN va_list vaList)
{
    if(fmt == zfnull) {return s;}
...
ZFCoreStringA &_ZFP_zfstringAppendV(ZF_OUT ZFCoreStringA &s, ZF_IN const zfcharA *fmt, va_list vaList)
{
    return _ZFP_zfstringAppendT(s, fmt, vaList);
}
ZFCoreStringW &_ZFP_zfstringAppendV(ZF_OUT ZFCoreStringW &s, ZF_IN const zfcharW *fmt, va_list vaList)
{
    return _ZFP_zfstringAppendT(s, fmt, vaList);
}
