...
extern ZF_ENV_EXPORT ZFCoreStringA &_ZFP_zfstringAppendV(ZF_OUT ZFCoreStringA &s, ZF_IN const zfcharA *fmt, va_list vaList);
extern ZF_ENV_EXPORT ZFCoreStringW &_ZFP_zfstringAppendV(ZF_OUT ZFCoreStringW &s, ZF_IN const zfcharW *fmt, va_list vaList);

template<typename T_Char, typename T_Str>
T_Str &_ZFP_zfstringAppend(ZF_OUT T_Str &s,
