...
public:
    /**
     * @brief get content info or #ZFTOKEN_ZFCoreElementContentInfoNotAvailable if not available
     * @see ZFCoreElementInfoGetter
     */
...
public:
    /**
     * @brief return hash of internal pointer
     */
...
public:
    /**
     * @brief custom info getter for #objectInfoOfContent, null to use default info getter
     */
...
public:
    /** @cond ZFPrivateDoc */
    ZFCorePointer(void) : ZFCorePointerBase()
    {
        d = zfnew(_ZFP_ZFCorePointerPrivate<T_Pointer>);
    }
    ZFCorePointer(ZF_IN T_Pointer const &value) : ZFCorePointerBase()
    {
        d = zfnew(_ZFP_ZFCorePointerPrivate<T_Pointer>);
        this->pointerValueSet(value);
    }
    ZFCorePointer(ZF_IN const ZFCorePointer<T_Pointer, T_ZFCorePointerType> &ref) : ZFCorePointerBase()
    {
        d = zfnull;
        this->operator =(ref);
    }
