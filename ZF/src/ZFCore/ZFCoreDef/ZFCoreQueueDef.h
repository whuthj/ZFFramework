...
public:
    ...
    zffinal void objectInfoOfContentT(ZF_IN_OUT zfstring &ret,
                                      ...
                                      ZF_IN_OPT typename ZFCoreInfoGetter<T_POD>::InfoGetter elementInfoGetter = ZFCoreElementInfoGetter<T_POD>::elementInfoGetter) const
    {
        zfindex count = 0;
        ret += token.tokenLeft;
    ...
    {
        zfstring ret;
        this->objectInfoOfContentT(ret, token);
        return ret;
    }
