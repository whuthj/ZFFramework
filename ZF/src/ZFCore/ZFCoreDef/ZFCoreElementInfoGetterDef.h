 ...
 */
#define ZFTOKEN_ZFCoreElementContentInfoNotAvailable zfText("N/A")
...
{
public:
    /** @brief see #ZFTOKEN_ZFCoreElementContentInfoNotAvailable */
    static void elementInfoGetter(ZF_IN_OUT zfstring &ret, ZF_IN T_Element const &v)
    {
        ret += ZFTOKEN_ZFCoreElementContentInfoNotAvailable;
    }
};
