...
#define zfCoreAssert(exp) \
    zfCoreAssertWithMessage(exp, zfTextA("assert failed for \"%s\""), ZFMACRO_TOSTRING_A(exp))

/**
 * @brief see #zfCoreAssert
 */
#define zfCoreAssertTrim(exp) \
    zfCoreAssertWithMessageTrim(exp, zfTextA("assert failed for \"%s\""), ZFMACRO_TOSTRING_A(exp))

/**
 * @brief see #zfCoreAssert
 */
#define zfCoreAssertDetail(exp, callerFile, callerFunction, callerLine) \
    zfCoreAssertWithMessageDetail(exp, callerFile, callerFunction, callerLine, zfTextA("assert failed for \"%s\""), ZFMACRO_TOSTRING_A(exp))
