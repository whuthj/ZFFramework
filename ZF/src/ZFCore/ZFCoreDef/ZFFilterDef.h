...
ZFCOMPARER_DEFAULT_DECLARE_BEGIN(ZFFilterType, e0, ZFFilterType, e1)
{
    return ((e0 == e1) ? ZFCompareTheSame : ZFCompareUncomparable);
}
ZFCOMPARER_DEFAULT_DECLARE_END(ZFFilterType, e0, ZFFilterType, e1)
...
ZFCOMPARER_DEFAULT_DECLARE_BEGIN(ZFFilterCallbackResult, e0, ZFFilterCallbackResult, e1)
{
    return ((e0 == e1) ? ZFCompareTheSame : ZFCompareUncomparable);
}
ZFCOMPARER_DEFAULT_DECLARE_END(ZFFilterCallbackResult, e0, ZFFilterCallbackResult, e1)
 ...
 * @code
 *   ZFFILTER_DECLARE(
 *       ChildClass<T_Public ZFMACRO_COMMA() T_Internal>,
 *       SuperClass<T_Public ZFMACRO_COMMA() T_Internal>)
 * @endcode
 */
...
private:
    static void _ZFP_ZFFilterBase_contentInfoGetter(ZF_IN_OUT zfstring &ret, ZF_IN const _ZFP_ZFFilterBaseFilterData<T_Internal> &v)
    {
        ...
        ZFCoreElementInfoGetter<T_Internal>::elementInfoGetter(ret, v.element);
        ret += ')';
    }
public:
    /**
...
{
    ZFFILTER_DECLARE(
        ZFFilterBasic<T_Public ZFMACRO_COMMA() T_Internal>,
        ZFFilterBase<T_Public ZFMACRO_COMMA() T_Internal>)
...
{
    ZFFILTER_DECLARE(
        ZFFilterForStringBase<T_Public ZFMACRO_COMMA() T_Internal>,
        ZFFilterBase<T_Public ZFMACRO_COMMA() T_Internal>)
