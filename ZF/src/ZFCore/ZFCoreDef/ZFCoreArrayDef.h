...
public:
    ...
    virtual void objectInfoOfContentT(ZF_IN_OUT zfstring &ret,
                                      ...
                                      ZF_IN_OPT typename ZFCoreInfoGetter<T_Element>::InfoGetter elementInfoGetter = ZFCoreElementInfoGetter<T_Element>::elementInfoGetter) const;
    /** @brief see #objectInfoOfContentT */
    virtual zfstring objectInfoOfContent(ZF_IN_OPT zfindex maxCount = zfindexMax,
                                         ZF_IN_OPT const ZFTokenForContainer &token = ZFTokenForContainerDefault,
                                         ZF_IN_OPT typename ZFCoreInfoGetter<T_Element>::InfoGetter elementInfoGetter = ZFCoreElementInfoGetter<T_Element>::elementInfoGetter) const
    {
        zfstring ret;
...
#define _ZFP_ZFCoreArrayCreate_action(CreatorType, values, ...) \
    CreatorType() ZFMACRO_FIX_PARAM(_ZFP_ZFCoreArrayCreate_action_expand, ZFMACRO_EMPTY, values, ##__VA_ARGS__) .array
/**
