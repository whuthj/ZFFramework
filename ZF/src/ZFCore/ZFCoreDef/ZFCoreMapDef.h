...
public:
     ...
     */
    zffinal ZFCoreArrayPOD<const zfchar *> allKey(void) const;
    /**
     * @brief return a copy of all values
     */
    zffinal ZFCoreArrayPOD<ZFCorePointerBase *> allValue(void) const;
    /**
     * @brief return a copy of all keys and values
     */
    zffinal ZFCoreArrayPOD<ZFCoreMapPair> allPair(void) const;
    /**
     * @brief return a copy of all values
     *
     ...
     */
    template<typename T_Element>
    ZFCoreArrayPOD<T_Element> allValue(void) const
    {
        ZFCoreArrayPOD<T_Element> ret;
