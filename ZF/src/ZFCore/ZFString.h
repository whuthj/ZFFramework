 ...
 */
#define ZFStringEncodingForZFChar ZFMACRO_CAT(ZFStringEncoding::e_, ZFMACRO_EXPAND(ZFStringEncodingNameForZFChar))

/**
 * @brief encoding used in zfcharA, see #ZFStringEncoding
 */
#define ZFStringEncodingForZFCharA ZFMACRO_CAT(ZFStringEncoding::e_, ZFMACRO_EXPAND(ZFStringEncodingNameForZFCharA))

/**
 * @brief encoding used in zfcharW, see #ZFStringEncoding
 */
#define ZFStringEncodingForZFCharW ZFMACRO_CAT(ZFStringEncoding::e_, ZFMACRO_EXPAND(ZFStringEncodingNameForZFCharW))

#define _ZFP_ZFStringCodeConv(s, fromType, toName, toCharType) \
    ((fromType == ZFStringEncoding::ZFMACRO_CAT(e_, toName)) \
        ? ZFCastReinterpret(const toCharType *, s) \
        : (ZFMACRO_CAT(ZFString::to, toName)(s, fromType).cString()))
/**
 * @def ZFStringZ2A
 ...
 * serializable data:
 * @code
 *   <ZFStringEncodingEnum value="value">
 *   </ZFStringEncodingEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFStringEncodingEnum zfText("ZFStringEncodingEnum")
/**
...
ZFENUM_SEPARATOR_ALLOW_DUPLICATE_VALUE(ZFStringEncoding)
    ...
    ZFENUM_VALUE_REGISTER_WITH_NAME(UTF16LE, zfText("e_UTF16"))
    ZFENUM_VALUE_REGISTER_WITH_NAME(UTF16BE, zfText("e_UTF16BE"))
    ZFENUM_VALUE_REGISTER_WITH_NAME(UTF16, zfText("e_UTF16"))
 ...
 * serializable data:
 * @code
 *   <ZFStringStorageTypeEnum value="value">
 *   </ZFStringStorageTypeEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFStringStorageTypeEnum zfText("ZFStringStorageTypeEnum")
/**
 ...
 * storage type is ensured #ZFStringStorageType::e_Default\n
 * \n
 * serializable data:
 * @code
 *   <StringClass
...
public:
    ...
    static zfbool toZFChar(ZF_OUT zfstring &result,
                           ...
                           ZF_IN ZFStringEncodingEnum srcEncoding)
    {
        return ZFMACRO_CAT(ZFString::to, ZFStringEncodingNameForZFChar)(result, s, srcEncoding);
    }
    /**
     * @brief see #toZFChar
     */
    static zfstring toZFChar(ZF_IN const void *s,
                             ...
                             ZF_OUT_OPT zfbool *success = zfnull)
    {
        return ZFMACRO_CAT(ZFString::to, ZFStringEncodingNameForZFChar)(s, srcEncoding, success);
    }
    /**
    ...
    static zfbool toZFCharA(ZF_OUT zfstringA &result,
                            ...
                            ZF_IN ZFStringEncodingEnum srcEncoding)
    {
        return ZFMACRO_CAT(ZFString::to, ZFStringEncodingNameForZFCharA)(result, s, srcEncoding);
    }
    /**
     * @brief see #toZFCharA
     */
    static zfstringA toZFCharA(ZF_IN const void *s,
                               ...
                               ZF_OUT_OPT zfbool *success = zfnull)
    {
        return ZFMACRO_CAT(ZFString::to, ZFStringEncodingNameForZFCharA)(s, srcEncoding, success);
    }
    /**
    ...
    static zfbool toZFCharW(ZF_OUT zfstringW &result,
                            ...
                            ZF_IN ZFStringEncodingEnum srcEncoding)
    {
        return ZFMACRO_CAT(ZFString::to, ZFStringEncodingNameForZFCharW)(result, s, srcEncoding);
    }
    /**
     * @brief see #toZFCharW
     */
    static zfstringW toZFCharW(ZF_IN const void *s,
                               ...
                               ZF_OUT_OPT zfbool *success = zfnull)
    {
        return ZFMACRO_CAT(ZFString::to, ZFStringEncodingNameForZFCharW)(s, srcEncoding, success);
    }
    /**
...
public:
    ...
    virtual ZFObject *objectOnInit(ZF_IN const zfchar *s,
                                   ZF_IN_OPT ZFStringStorageTypeEnum storageType = ZFStringStorageType::e_Default());
    /**
...
protected:
     ...
     *
     * store as #ZFStringStorageType::e_Default by default,
