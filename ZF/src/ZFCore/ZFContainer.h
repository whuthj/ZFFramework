 ...
 *   see #serializableOnSerializeCategoryToData for more info
 */
...
protected:
    ...
    /**
     * @brief see #ZFSerializable::serializableOnSerializeCategoryToData
     *
     ...
     * and would call #serializableOnSerializeCategoryToDataWithRef otherwise,
     * you should override #serializableOnSerializeCategoryToDataWithRef
...
protected:
    /**
     * @brief see #serializableOnSerializeCategoryToData
     */
    virtual zfbool serializableOnSerializeCategoryToDataWithRef(ZF_IN_OUT ZFSerializableData &ownerData,
                                                                ZF_IN ZFSerializable *referencedOwnerOrNull,
