...
public:
    ...
    virtual ZFFileToken fileOpen(ZF_IN const zfchar *filePath,
                                 ZF_IN_OPT ZFFileOpenOptionFlags flag = ZFFileOpenOption::e_Read) = 0;
    /** @brief see #ZFFile::fileClose */
    virtual zfbool fileClose(ZF_IN ZFFileToken token) = 0;

    /** @brief see #ZFFile::fileTell */
    virtual zfindex fileTell(ZF_IN ZFFileToken token) = 0;
    /** @brief see #ZFFile::fileSeek */
    virtual zfbool fileSeek(ZF_IN ZFFileToken token,
                            ZF_IN zfindex byteSize,
                            ZF_IN_OPT ZFSeekPos position = ZFSeekPosBegin) = 0;

    /** @brief see #ZFFile::fileRead */
    virtual zfindex fileRead(ZF_IN ZFFileToken token,
                             ZF_IN void *buf,
                             ZF_IN zfindex maxByteSize) = 0;
    ...
    virtual void fileFlush(ZF_IN ZFFileToken token) = 0;
    /** @brief see #ZFFile::fileEof */
    virtual zfbool fileEof(ZF_IN ZFFileToken token) = 0;
    /** @brief see #ZFFile::fileError */
    virtual zfbool fileError(ZF_IN ZFFileToken token) = 0;
