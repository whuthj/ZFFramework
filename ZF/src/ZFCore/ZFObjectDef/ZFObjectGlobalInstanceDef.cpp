...
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, ZFFrameworkEssential), ZFLevelZFFrameworkEssential)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, ZFFrameworkHigh), ZFLevelZFFrameworkHigh)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, ZFFrameworkNormal), ZFLevelZFFrameworkNormal)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, ZFFrameworkLow), ZFLevelZFFrameworkLow)

_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, AppEssential), ZFLevelAppEssential)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, AppHigh), ZFLevelAppHigh)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, AppNormal), ZFLevelAppNormal)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, AppLow), ZFLevelAppLow)

_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, ZFFrameworkPostLow), ZFLevelZFFrameworkPostLow)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, ZFFrameworkPostNormal), ZFLevelZFFrameworkPostNormal)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, ZFFrameworkPostHigh), ZFLevelZFFrameworkPostHigh)
_ZFP_ZFObjectGlobalInstanceDefine(ZFMACRO_CAT(ZFObjectGlobalInstanceLevel, ZFFrameworkPostEssential), ZFLevelZFFrameworkPostEssential)
...
// ============================================================
ZF_STATIC_INITIALIZER_INIT_WITH_LEVEL(ZFClassSingletonInstanceRefHolder, ZFLevelZFFrameworkEssential)
{
}
