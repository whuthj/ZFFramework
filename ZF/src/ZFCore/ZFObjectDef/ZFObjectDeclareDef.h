...
#define zfsuperI(T_SuperType) \
    _ZFP_zfsuperI<zfsuper, T_SuperType, ZFMACRO_CLASS_IS_TYPE_OF(zfsuper, T_SuperType)>::SuperType
...
#define ZFOBJECT_REGISTER(T_ZFObject) \
    ZF_STATIC_INITIALIZER_INIT_WITH_LEVEL(ZFObjectRegister_##T_ZFObject, ZFLevelZFFrameworkNormal) \
    { \
