 ...
 *   // ============================================================
 *   // in h file
 *   // define a property type id is required
 *   #define ZFPropertyTypeId_EnumNameEnum zfText("EnumNameEnum")
 *  / **
...
#define _ZFP_ZFENUM_SEPARATOR(ChildEnum, isEnableDuplicateValue_) \
    ...
    private: \
        ...
        { \
            static _ZFP_ZFEnumData *d = _ZFP_ZFEnumDataAccess(ZFMACRO_TOSTRING(ChildEnum)); \
            if(d->needInitFlag) \
            { \
...
#define ZFENUM_END_WITH_DEFAULT(ChildEnum, defaultEnum) \
    ...
    public: \
        ...
        static inline ChildEnum::ZFEnumType e_Default(void) \
        { \
...
inline zfstring zfflagsToString(ZF_IN ZFEnum *enumObj,
                                ZF_IN zfflags const &value,
                                ZF_IN_OPT zfbool includeNotConverted = zftrue,
                                ZF_IN_OPT zfbool exclusiveMode = zffalse,
                                ZF_OUT_OPT zfflags *notConverted = zfnull,
...
{
    zfstring ret;
    zfflagsToString(ret, enumObj, value, includeNotConverted, exclusiveMode, notConverted, separatorToken);
    return ret;
}
/**
 ...
 * @code
 *   // in .h file
 *   // declare a property type id is required
 *   #define ZFPropertyTypeId_YourEnumFlagsType zfText("YourEnumFlagsType")
...
#define ZFENUM_FLAGS_DECLARE(EnumName, EnumFlagsName) \
    _ZFP_ZFENUM_FLAGS_DECLARE(EnumName, EnumFlagsName, ZFMACRO_EMPTY()) \
...
#define _ZFP_ZFENUM_FLAGS_DEFAULT_EXPAND(EnumName, EnumFlagsName, defaultValue) \
    public: \
        ...
        static inline ZFEnumValue e_Default(void) \
        { \
            return defaultValue; \
        }
/**
 * @brief see #ZFENUM_FLAGS_DECLARE, declare with default value,
 *   which can be accessed by YourEnumFlagsType::e_Default()
 */
