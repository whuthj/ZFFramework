...
ZF_STATIC_INITIALIZER_INIT_WITH_LEVEL(ZFLeakTestVerboseObserverDataHolder, ZFLevelZFFrameworkEssential)
{
    _ZFP_ZFLeakTestVerboseObserverEnabled = zffalse;
}
ZFCoreArrayPOD<const ZFClass *> clsList;
ZFCoreArrayPOD<ZFObject *> objList;
ZF_STATIC_INITIALIZER_END(ZFLeakTestVerboseObserverDataHolder)
...
ZF_STATIC_INITIALIZER_INIT_WITH_LEVEL(ZFLeakTestGlobalExcludeData, ZFLevelZFFrameworkEssential)
{
}
...
// ============================================================
// global type
#define ZFPropertyTypeId__ZFP_ZFLeakTestActionEnum zfText("_ZFP_ZFLeakTestActionEnum")
...
// ============================================================
// onAlloc
void _ZFP_ZFLeakTestLogAlloc(ZF_IN ZFObject *obj,
                             ZF_IN const zfcharA *callerFile,
                             ZF_IN const zfcharA *callerFunction,
                             ZF_IN zfindex callerLine)
{
    ...
    if(_ZFP_ZFLeakTestVerboseObserverEnabled && _ZFP_ZFLeakTestVerboseObserverContain(obj))
    {
        zfstring s = zfstringWithFormat(zfText("[ZFLeakTest] %s(%2zi) %s %s\n"),
...
// ============================================================
// objectOnRetain
void _ZFP_ZFLeakTestLogRetain(ZF_IN ZFObject *obj,
                              ZF_IN const zfcharA *callerFile,
                              ZF_IN const zfcharA *callerFunction,
                              ZF_IN zfindex callerLine)
{
...
// ============================================================
// objectOnRelease
void _ZFP_ZFLeakTestLogRelease(ZF_IN ZFObject *obj,
                               ZF_IN const zfcharA *callerFile,
                               ZF_IN const zfcharA *callerFunction,
                               ZF_IN zfindex callerLine)
{
...
// ============================================================
// onAutoRelease
void _ZFP_ZFLeakTestLogAutoRelease(ZF_IN ZFObject *obj,
                                   ZF_IN const zfcharA *callerFile,
                                   ZF_IN const zfcharA *callerFunction,
                                   ZF_IN zfindex callerLine)
{
...
void _ZFP_ZFLeakTestLogAutoReleaseBeforeRelease(ZF_IN ZFObject *obj)
{
    ...
    if(_ZFP_ZFLeakTestVerboseObserverEnabled && _ZFP_ZFLeakTestVerboseObserverContain(obj))
    {
        zfstring s = zfstringWithFormat(zfText("[ZFLeakTest] %s(%2zi) %s\n"),
...
// ============================================================
// objectOnDealloc
void _ZFP_ZFLeakTestLogDealloc(ZF_IN ZFObject *obj)
{
    if(!_ZFP_ZFLeakTestInitFlag)
    {
        return ;
    ...
    if(_ZFP_ZFLeakTestVerboseObserverEnabled)
    {
        ZF_STATIC_INITIALIZER_INSTANCE(ZFLeakTestVerboseObserverDataHolder)->objList.removeElement(obj);
    }
                                ...
                                ZF_IN_OPT const ZFLeakTestObjectFilter &filter /* = _ZFP_ZFLeakTestObjectFilterNull */)
{
        ...
        ++it)
    {
        if(filter.filterCheckActive(it->first)
            ...
            && !it->first->classData()->classIsInternal())
        {
