...
public:
    ...
    {
        return *ZFCastStatic(typename zftypeTraits<T_RawType>::ConstPointer, this->holdedData);
    }
...
public:
    ...
    inline T_RawType holdedDataRef(void)
    {
        return *ZFCastStatic(typename zftypeTraits<T_RawType>::Pointer, this->holdedData);
    }
...
ZFMACRO_CLASS_HAS_MEMBER_DECLARE(_ZFP_ZFObjectTypeChecker, ClassData, const ZFClass * (*F)(void))
/** @cond ZFPrivateDoc */
template<typename T0, typename T1>
zfclassNotPOD ZFComparerDefaultHolder<T0, T1
    , void, void
    , typename ZFMACRO_ENABLE_IF(ZFMACRO_CLASS_HAS_MEMBER(_ZFP_ZFObjectTypeChecker, ClassData, typename zftypeTraits<T0>::Traits))
    , typename ZFMACRO_ENABLE_IF(ZFMACRO_CLASS_HAS_MEMBER(_ZFP_ZFObjectTypeChecker, ClassData, typename zftypeTraits<T1>::Traits))
    >
{
public:
...
zfclassNotPOD ZFCoreElementInfoGetter<T_ZFObject
        , typename ZFMACRO_ENABLE_IF(ZFMACRO_CLASS_HAS_MEMBER(_ZFP_ZFObjectTypeChecker, ClassData, typename zftypeTraits<T_ZFObject>::Traits))
    >
{
public:
