...
// ============================================================
// zfAlloc
template<typename T_ZFObject, zfint valid>
...
template<typename T_ZFObject, zfint isZFObjectType>
...
inline T_ZFObject *_ZFP_zfRetain(ZF_IN T_ZFObject *obj)
{
    if(obj)
    {
        _ZFP_zfRetainHolder<T_ZFObject, ZFMACRO_CLASS_IS_TYPE_OF(T_ZFObject, ZFObject)>::action(obj);
    }
    return obj;
}
...
inline void _ZFP_zfRelease(ZF_IN T_ZFObject *obj)
{
    if(obj)
    {
        _ZFP_zfReleaseHolder<T_ZFObject, ZFMACRO_CLASS_IS_TYPE_OF(T_ZFObject, ZFObject)>::action(obj);
    }
}
