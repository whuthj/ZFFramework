...
#define _ZFP_ZFPROPERTY_DECLARE(Type, ZFPropertyTypeId_noneOrType, Name, \
    ...
    public: \
        ...
        { \
            ZFProperty *_propertyInfo = _ZFP_ZFPropertyAccess( \
                zfsConnectLineFree(zfself::ClassData()->className(), zfText("::"), ZFMACRO_TOSTRING(Name))); \
...
#define _ZFP_ZFPROPERTY_VALUE_DECLARE_RETAIN(Type, ZFPropertyTypeId_noneOrType, Name, \
    ...
    public: \
        ZFMACRO_CLASS_HAS_MEMBER_DECLARE(_, _ZFP_ZFPropertyRawInitStep_##Name, void (*F)(ZF_IN_OUT zfautoObject &)) \
        /* ZFDoxygenBugFix */ \
        /* can't be filtered by "_ZFP_*", reason unknown */ \
        /** @cond ZFPrivateDoc */ \
        template<typename T_Owner, zfint hasCustom> \
    ...
    private: \
        ...
        public: \
            ...
            { \
                ...
                { \
                    ZFCoreMutexLock(); \
                    T_Type *valueTmp = zfpoolNew(Type, ZFPropertyInitValueOrNoInitValue); \
                    _ZFP_ZFPropertyRawInitStepInvoker_##Name<zfself, \
                        ZFMACRO_CLASS_HAS_MEMBER(_, _ZFP_ZFPropertyRawInitStep_##Name, zfself)>::action(owner, *valueTmp); \
                    if(owner->classData()->_ZFP_ZFClass_propertyInitStepAction( \
                        owner->toObject(), \
                        zfself::_ZFP_ZFProperty_##Name(), \
        ...
        _ZFP_ZFPropertyValue_##Name<Type> Name##_ZFPropertyValue; \
    public: \
        ZFMACRO_CLASS_HAS_MEMBER_DECLARE(_, _ZFP_ZFPropertyRawInitStep_##Name, void (*F)(ZF_IN_OUT Type &)) \
        /* ZFDoxygenBugFix */ \
        /* can't be filtered by "_ZFP_*", reason unknown */ \
        /** @cond ZFPrivateDoc */ \
        template<typename T_Owner, zfint hasCustom> \
...
#define _ZFP_ZFPROPERTY_DECLARE_CALLBACK_IS_INIT_VALUE(Type, Name) \
    private: \
        ...
        static zfbool _ZFP_ZFPropertyCallbackIsInitValue_##Name(ZF_IN const ZFProperty *property, \
                                                                ZF_IN ZFObject *ownerObj) \
        { \
            return ZFCastZFObjectUnchecked(zfself *, ownerObj)->_ZFP_ZFPropertyCallbackIsInitValueAction_##Name(); \
        } \
        virtual zfbool _ZFP_ZFPropertyCallbackIsInitValueAction_##Name(void) \
        { \
            return _ZFP_ZFPropertyCallbackIsInitValueActionWrapper_##Name<zfself, \
                    ZFMACRO_CLASS_HAS_MEMBER(_, _ZFP_ZFPropertyCallbackIsInitValueActionCustom_##Name, zfself) \
                >::action(this); \
        } \
        ZFMACRO_CLASS_HAS_MEMBER_DECLARE(_, _ZFP_ZFPropertyCallbackIsInitValueActionCustom_##Name, zfbool (T::*F)(void)) \
        template<typename T_Owner, zfint hasCustom> \
        zfclassNotPOD _ZFP_ZFPropertyCallbackIsInitValueActionWrapper_##Name \
        { \
        public: \
            static inline zfbool action(ZF_IN T_Owner *owner) \
            { \
                return owner->_ZFP_ZFPropertyCallbackIsInitValueActionInternal_##Name(); \
            } \
        }; \
        template<typename T_Owner> \
        ...
        public: \
            static inline zfbool action(ZF_IN T_Owner *owner) \
            { \
                return owner->_ZFP_ZFPropertyCallbackIsInitValueActionCustom_##Name(); \
            } \
        }; \
    public: \
        zfbool _ZFP_ZFPropertyCallbackIsInitValueActionInternal_##Name(void) \
        { \
            return (!Name##_ZFPropertyValue.propertyAccessed() || (ZFComparerDefault( \
                    this->_ZFP_ZFPROPERTY_GETTER_NAME_INTERNAL(Type, Name)(), _ZFP_ZFPROPERTY_INIT_VALUE_WRAPPER(Type, Name)) \
                == ZFCompareTheSame)); \
        }
    ...
    private: \
        ...
        { \
            return _ZFP_ZFPropertyCallbackCompareActionWrapper_##Name<zfself, \
                    ZFMACRO_CLASS_HAS_MEMBER(_, _ZFP_ZFPropertyCallbackCompareActionCustom_##Name, zfself) \
                >::action(this, anotherObj); \
        } \
        ZFMACRO_CLASS_HAS_MEMBER_DECLARE(_, _ZFP_ZFPropertyCallbackCompareActionCustom_##Name, ZFCompareResult (T::*F)(ZF_IN ZFObject *)) \
        template<typename T_Owner, zfint hasCustom> \
...
#define _ZFP_ZFPROPERTY_DECLARE_CALLBACK_COPY(Type, Name) \
    private: \
        ...
        { \
            property->setterMethod()->executeClassMember<void, Type const &>(dstObj, \
                property->getterMethod()->executeClassMember<Type const &>(srcObj)); \
        }
#define _ZFP_ZFPROPERTY_DECLARE_CALLBACK_RETAIN(Type, Name) \
    private: \
        static void _ZFP_ZFPropertyCallbackRetainSet_##Name(ZF_IN const ZFProperty *property, \
                                                            ...
                                                            ZF_IN ZFObject *src) \
        { \
            property->setterMethod()->executeClassMember<void, Type const &>(dstObj, ZFCastZFObjectUnchecked(Type, src)); \
        } \
        static ZFObject *_ZFP_ZFPropertyCallbackRetainGet_##Name(ZF_IN const ZFProperty *property, \
                                                                 ZF_IN ZFObject *ownerObj) \
        { \
            return ZFCastZFObjectUnchecked(ZFObject *, property->getterMethod()->executeClassMember<Type const &>(ownerObj)); \
        } \
...
#define _ZFP_ZFPROPERTY_DECLARE_CALLBACK_ASSIGN(Type, Name) \
    private: \
        static void _ZFP_ZFPropertyCallbackAssignSet_##Name(ZF_IN const ZFProperty *property, \
                                                            ...
                                                            ZF_IN void *src) \
        { \
            property->setterMethod()->executeClassMember<void, Type const &>(dstObj, *(ZFCastStatic(Type *, src))); \
        } \
...
#define _ZFP_ZFPROPERTY_DECLARE_RETAIN(Type, ZFPropertyTypeId_noneOrType, Name, \
    ...
    _ZFP_ZFPROPERTY_DECLARE(Type, ZFPropertyTypeId_noneOrType, Name, \
                            zftypeTraits<Type>::Traits::ClassData()) \
...
// ============================================================
#define _ZFP_ZFPROPERTY_INIT_VALUE_WRAPPER(Type, Name) \
    (zfself::_ZFP_ZFPropertyValue_##Name<Type>().propertyInit(this, zffalse))
...
// ============================================================
#define _ZFP_ZFPROPERTY_SETTER(AccessType, Type, Name, DefaultValueFix) \
    AccessType: \
        ZFMETHOD_MEMBER_DECLARE_NO_AUTOREGISTER_1( \
            AccessType, ZFMethodNotStatic, ZFMethodIsVirtual, ZFMethodNotConst, \
            void, _ZFP_ZFPROPERTY_SETTER_NAME(Type, Name), ZFMethodNoId, \
            Type const &, newValue, DefaultValueFix) \
        { \
            _ZFP_ZFPropertySetterWrapper_##Name<zfself, \
                    ZFMACRO_CLASS_HAS_MEMBER(_, _ZFP_ZFPropertySetterCustom_##Name, zfself) \
                >::action(this, newValue); \
        } \
    private: \
        ZFMACRO_CLASS_HAS_MEMBER_DECLARE(_, _ZFP_ZFPropertySetterCustom_##Name, void (T::*F)(ZF_IN Type const &)) \
        template<typename T_Owner, zfint hasCustom> \
...
#define _ZFP_ZFPROPERTY_GETTER(AccessType, Type, Name) \
    AccessType: \
        ZFMETHOD_MEMBER_DECLARE_NO_AUTOREGISTER_0( \
            AccessType, ZFMethodNotStatic, ZFMethodIsVirtual, ZFMethodNotConst, \
            Type const &, _ZFP_ZFPROPERTY_GETTER_NAME(Type, Name), ZFMethodNoId) \
        { \
            return _ZFP_ZFPropertyGetterWrapper_##Name<zfself, \
                    ZFMACRO_CLASS_HAS_MEMBER(_, _ZFP_ZFPropertyGetterCustom_##Name, zfself) \
                >::action(this); \
        } \
    private: \
        ZFMACRO_CLASS_HAS_MEMBER_DECLARE(_, _ZFP_ZFPropertyGetterCustom_##Name, Type const & (T::*F)(void)) \
        template<typename T_Owner, zfint hasCustom> \
...
/** @brief see #ZFPROPERTY_RETAIN */
#define ZFPropertyNoDefaultValue ZFMethodNoDefaultParam
/** @brief see #ZFPROPERTY_RETAIN */
#define ZFPropertyDefaultValue(DefaultValue) ZFMethodDefaultParam(DefaultValue)
...
#define ZFPROPERTY_RETAIN_NOT_SERIALIZABLE( \
    Type, Name, \
    ZFPropertyInitValueOrNoInitValue, \
    ZFPropertyDefaultValueOrNoDefaultValue, \
    SetterAccessType, \
    GetterAccessType) \
        ...
        /** @brief see @ref Name */ \
        _ZFP_ZFPROPERTY_SETTER(SetterAccessType, Type, Name, ZFPropertyDefaultValueOrNoDefaultValue) \
        /** @brief internal getter, see @ref Name */ \
...
#define ZFPROPERTY_RETAIN_WITH_INIT( \
    ...
    ZFPROPERTY_RETAIN_DETAIL( \
        Type, Name, \
        ZFPropertyInitValueOrNoInitValue, \
        ZFPropertyNoDefaultValue, \
        public, \
        public)
/** @brief see #ZFPROPERTY_RETAIN */
#define ZFPROPERTY_RETAIN_WITH_DEFAULT( \
    Type, Name, \
    ZFPropertyInitValueOrNoInitValue, ZFPropertyDefaultValueOrNoDefaultValue) \
    ZFPROPERTY_RETAIN_DETAIL( \
        Type, Name, \
        ZFPropertyInitValueOrNoInitValue, \
        ZFPropertyDefaultValueOrNoDefaultValue, \
 ...
 *   ZFPROPERTY_RETAIN_DETAIL(
 *       Type, Name, ZFPropertyInitValueOrNoInitValue, ZFPropertyDefaultValueOrNoDefaultValue,
 *       SetterAccessType,
 *       GetterAccessType)\n
 ...
 *   the ZFPropertyDefaultValueOrNoDefaultValue could be
 *     ZFPropertyNoDefaultValue or ZFPropertyDefaultValue(YourDefaultValue),
 *     it's the default value for the setter\n
 ...
 *             ZFPropertyNoInitValue, ZFPropertyDefaultValue(zfstring(zfText("Default"))),
 *             public,
 *             public)
 *
...
#define ZFPROPERTY_ASSIGN_WITH_INIT( \
    ...
    ZFPROPERTY_ASSIGN_DETAIL( \
        ...
        public)
/** @brief see #ZFPROPERTY_RETAIN */
#define ZFPROPERTY_ASSIGN_WITH_DEFAULT( \
    Type, Name, \
    ZFPropertyInitValueOrNoInitValue, ZFPropertyDefaultValueOrNoDefaultValue) \
    ZFPROPERTY_ASSIGN_DETAIL( \
        Type, Name, \
...
#define ZFPROPERTY_CUSTOM_INIT_VALUE_CHECKER_DECLARE(Type, Name) \
    public: \
        zfbool _ZFP_ZFPropertyCallbackIsInitValueActionCustom_##Name(void)
/** @brief see #ZFPROPERTY_RETAIN */
#define ZFPROPERTY_CUSTOM_INIT_VALUE_CHECKER_DEFINE(OwnerClass, Type, Name) \
    zfbool OwnerClass::_ZFP_ZFPropertyCallbackIsInitValueActionCustom_##Name(void)
...
#define ZFPROPERTY_CUSTOM_GETTER_DECLARE(Type, Name) \
    public: \
        Type const &_ZFP_ZFPropertySetterCustom_##Name(void)
/** @brief see #ZFPROPERTY_RETAIN */
#define ZFPROPERTY_CUSTOM_GETTER_DEFINE(OwnerClass, Type, Name) \
    Type const &OwnerClass::_ZFP_ZFPropertySetterCustom_##Name(void)
            ...
            { \
                ...
                { \
                    ...
                    T_OwnerZFObject::ClassData()->_ZFP_ZFClass_propertyInitStepRegister( \
                        ZFPropertyGet(T_OwnerZFObject::ClassData(), #Name), \
...
#define ZFPROPERTY_OVERRIDE_INIT_VALUE_CHECKER_DEFINE(OwnerClass, Type, Name) \
    zfbool OwnerClass::_ZFP_ZFPropertyCallbackIsInitValueAction_##Name(void)
/**
 * @brief see #ZFPROPERTY_OVERRIDE_INIT_VALUE_CHECKER_DECLARE
 */
#define ZFPROPERTY_OVERRIDE_INIT_VALUE_CHECKER_CALLSUPER(SuperOwnerClass, Type, Name) \
    SuperOwnerClass::_ZFP_ZFPropertyCallbackIsInitValueAction_##Name()
...
#define ZFPROPERTY_REGISTER(OwnerClass, Type, Name) \
    ZF_STATIC_INITIALIZER_INIT_WITH_LEVEL(ZFPropertyRegister_##OwnerClass##_##Name, ZFLevelZFFrameworkNormal) \
    { \
