...
{
    return ((obj->classData()->classIsSubclassOf(zftypeTraits<T_ZFObjectTo>::Traits::ClassData()))
...
ZFMACRO_CLASS_HAS_MEMBER_DECLARE(_ZFP_ZFCastZFObject, ClassData, const ZFClass * (*F)(void))
#define _ZFP_ZFCastZFObject_enableIfNotUnknown(Type) \
    typename ZFMACRO_ENABLE_IF(ZFMACRO_CLASS_HAS_MEMBER(_ZFP_ZFCastZFObject, ClassData, typename zftypeTraits<Type>::Traits))
#define _ZFP_ZFCastZFObject_enableIfUnknown(Type) \
    typename ZFMACRO_ENABLE_IF(!ZFMACRO_CLASS_HAS_MEMBER(_ZFP_ZFCastZFObject, ClassData, typename zftypeTraits<Type>::Traits))
#define _ZFP_ZFCastZFObject_enableIfObject(Type) \
    typename ZFMACRO_ENABLE_IF(ZFMACRO_CLASS_IS_TYPE_OF(typename zftypeTraits<Type>::Traits, ZFObject))
    ...
    static inline T_To caster(T_From const &obj)
    {
        return (obj
            ? static_cast<T_To>(obj->classData()->_ZFP_ZFClass_interfaceCast(
                obj->toObject(),
                zftypeTraits<T_To>::Traits::ClassData()))
            : zfnull);
    }
};
// object to interface
...
inline T_To _ZFP_ZFCastZFObject<T_To>::caster(T_From const &obj)
{
    return _ZFP_ZFCastZFObjectHolder<T_To, T_From,
            ZFMACRO_CLASS_IS_TYPE_OF(typename zftypeTraits<T_From>::Traits, typename zftypeTraits<T_To>::Traits)
        >::caster(obj);
}
