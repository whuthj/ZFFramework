 ...
 * usage:
 * @code
 *   ZFOUTPUT_TYPE_TEMPLATE(typename T0 ZFMACRO_COMMA() typename T1,
 *                          YourType<T0 ZFMACRO_COMMA() T1>,
...
#define ZFCallbackSerializeCustomTypeName_ZFInputCallbackForInputInRange ZFMACRO_TOSTRING(ZFCallbackSerializeCustomType_ZFInputCallbackForInputInRange)
