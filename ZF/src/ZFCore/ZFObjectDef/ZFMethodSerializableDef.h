 ...
 *   // or, for function type:
 *   <ZFMethod namespace="method_namespace" method="MethodName" methodId="methodId" /> // methodId is optional
 * @endcode
 */
...
/** @brief keyword for serialize */
#define ZFSerializableKeyword_ZFMethod_namespace zfText("namespace")
/** @brief keyword for serialize */
