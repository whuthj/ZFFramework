...
#define ZFCORE_PARAM_RETAIN(T_ParamType, paramName) \
    ZFCORE_PARAM_RETAIN_WITH_INIT(T_ParamType, paramName, ZFMACRO_EMPTY())
/**
...
#define ZFCORE_PARAM_RETAIN_WITH_INIT(T_ParamType, paramName, initValue) \
    ...
    private: \
        ...
        public: \
            ...
            { \
                ...
                zflockfree_ZFLeakTestLogRetainVerbose(this->value, ZF_CALLER_FILE, #paramName zfTextA(" init"), ZF_CALLER_LINE); \
                ZFCoreMutexUnlock(); \
                zfdelete(t); \
            } \
            ...
            { \
                ...
                zflockfree_ZFLeakTestLogRetainVerbose(this->value, ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE); \
                ZFCoreMutexUnlock(); \
            } \
            ~paramName##_ZFCoreParam(void) \
            { \
                ZFCoreMutexLock(); \
                zflockfree_ZFLeakTestLogReleaseVerbose(this->value, ZF_CALLER_FILE, #paramName zfTextA(" cleanup"), ZF_CALLER_LINE); \
            ...
            { \
                ZFCoreMutexLock(); \
                zflockfree_ZFLeakTestLogRetainVerbose(ref.value, ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE); \
                zflockfree_zfRetainWithoutLeakTest(ref.value); \
                zflockfree_ZFLeakTestLogReleaseVerbose(this->value, ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE); \
                zflockfree_zfReleaseWithoutLeakTest(this->value); \
                ZFCoreMutexUnlock(); \
    ...
    public: \
        ...
        { \
            ZFCoreMutexLock(); \
            zflockfree_ZFLeakTestLogRetainVerbose(value, ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE); \
            zflockfree_zfRetainWithoutLeakTest(value); \
            zflockfree_ZFLeakTestLogReleaseVerbose(this->paramName##_.value, ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE); \
...
#define _ZFP_ZFCORE_PARAM_RETAIN_DEFINE(T_Owner, T_ParamType, paramName, initValue) \
    ...
    { \
        ...
        ZFCoreMutexLock(); \
        this->value = zflockfree_zfRetainWithoutLeakTest(*(t = zfnew(T_ParamType, initValue))); \
        zflockfree_ZFLeakTestLogRetainVerbose(this->value, this->_callerFile(), #paramName zfTextA(" init"), this->_callerLine()); \
        ZFCoreMutexUnlock(); \
        zfdelete(t); \
    } \
    ...
    { \
        ZFCoreMutexLock(); \
        this->value = zflockfree_zfRetainWithoutLeakTest(ref.value); \
        ZFLeakTestLogRetainVerbose(this->value, this->_callerFile(), #paramName zfTextA("Set"), this->_callerLine()); \
        ZFCoreMutexUnlock(); \
    } \
    T_Owner::paramName##_ZFCoreParam::~paramName##_ZFCoreParam(void) \
    { \
        ZFCoreMutexLock(); \
        zflockfree_ZFLeakTestLogReleaseVerbose(this->value, this->_callerFile(), #paramName zfTextA(" cleanup"), this->_callerLine()); \
        zflockfree_zfReleaseWithoutLeakTest(this->value); \
        ZFCoreMutexUnlock(); \
    } \
    ...
    { \
        ZFCoreMutexLock(); \
        zflockfree_ZFLeakTestLogRetainVerbose(ref.value, this->_callerFile(), #paramName zfTextA("Set"), this->_callerLine()); \
        zflockfree_zfRetainWithoutLeakTest(ref.value); \
        zflockfree_ZFLeakTestLogReleaseVerbose(this->value, this->_callerFile(), #paramName zfTextA("Set"), this->_callerLine()); \
        zflockfree_zfReleaseWithoutLeakTest(this->value); \
        ZFCoreMutexUnlock(); \
        this->value = ref.value; \
        return *this; \
    ...
    { \
        ZFCoreMutexLock(); \
        zflockfree_ZFLeakTestLogRetainVerbose(value, this->paramName##_._callerFile(), #paramName zfTextA("Set"), this->paramName##_._callerLine()); \
        zflockfree_zfRetainWithoutLeakTest(value); \
        zflockfree_ZFLeakTestLogReleaseVerbose(this->paramName##_.value, this->paramName##_._callerFile(), #paramName zfTextA("Set"), this->paramName##_._callerLine()); \
        zflockfree_zfReleaseWithoutLeakTest(this->paramName##_.value); \
        ZFCoreMutexUnlock(); \
        this->paramName##_.value = value; \
        return *this; \
