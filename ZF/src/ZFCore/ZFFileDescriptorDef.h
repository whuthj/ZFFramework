...
#define ZFCallbackSerializeCustomTypeName_ZFInputCallbackForFileDescriptor ZFMACRO_TOSTRING(ZFCallbackSerializeCustomType_ZFInputCallbackForFileDescriptor)
...
/** @brief see #ZFCallbackSerializeCustomTypeRegister */
#define ZFCallbackSerializeCustomTypeName_ZFOutputCallbackForFileDescriptor ZFMACRO_TOSTRING(ZFCallbackSerializeCustomType_ZFOutputCallbackForFileDescriptor)
 ...
 */
extern ZF_ENV_EXPORT ZFCoreArrayPOD<const zfchar *> ZFFileDescriptorTypeGetAll(void);
