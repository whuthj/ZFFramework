...
public:
     ...
     */
    virtual ZFCoreArrayPOD<ZFObject *> allKey(void);
    /**
     * @brief get a copy of all value
     */
    virtual ZFCoreArrayPOD<ZFObject *> allValue(void);
    /**
     * @brief get a copy of all key value pair
     */
    virtual ZFCoreArrayPOD<ZFKeyValuePair> allPair(void);
...
public:
    ...
    {
        ZFCoreArrayPOD<ZFObject *> tmp = this->allKey();
        ZFCoreArrayPOD<T_ZFObject> ret;
        for(zfindex i = 0; i < tmp.count(); ++i)
        {
            ret.add(ZFCastZFObjectUnchecked(T_ZFObject, tmp.get(i)));
        }
        return ret;
    }
    /**
    ...
    {
        ZFCoreArrayPOD<ZFObject *> tmp = this->allValue();
        ZFCoreArrayPOD<T_ZFObject> ret;
        for(zfindex i = 0; i < tmp.count(); ++i)
        {
            ret.add(ZFCastZFObjectUnchecked(T_ZFObject, tmp.get(i)));
