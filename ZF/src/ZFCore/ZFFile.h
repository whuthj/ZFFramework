 ...
 * serializable data:
 * @code
 *   <ZFFileOpenOptionEnum value="value">
 *   </ZFFileOpenOptionEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFFileOpenOptionEnum zfText("ZFFileOpenOptionEnum")
/**
 ...
 * serializable data:
 * @code
 *   <ZFFileOpenOptionFlags value="value">
 *   </ZFFileOpenOptionFlags>
 * @endcode
 */
#define ZFPropertyTypeId_ZFFileOpenOptionFlags zfText("ZFFileOpenOptionFlags")
...
public:
     ...
     * \n
     * a resource file is a file in res directory of native project,
     * such as "project_path/res/1.png" and "project_path/res/subdir/1.png",
...
public:
    /** @cond ZFPrivateDoc */
    explicit ZFFileBlockedCloseHolder(ZF_IN ZFFileToken token)
    : token(token)
    {
    }
...
public:
    /** @cond ZFPrivateDoc */
    explicit ZFFileBlockedResCloseHolder(ZF_IN ZFFileToken token)
    : token(token)
    {
    }
