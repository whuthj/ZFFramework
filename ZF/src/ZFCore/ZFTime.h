 ...
 * @code
 *   <TimeClass>
 *       <ZFTimeValue category="timeValue" /> // ZFTime::timeValueSet, optional, ZFTimeValueZero by default
 *       <ZFTimeValue category="timeZone" /> // ZFTime::timeZoneSet, optional, ZFTimeValueZero by default
 *   </TimeClass>
 * @endcode
 */
