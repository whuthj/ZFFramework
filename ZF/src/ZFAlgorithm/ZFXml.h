 ...
 * serializable data:
 * @code
 *   <ZFXmlTypeEnum value="value">
 *   </ZFXmlTypeEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFXmlTypeEnum zfText("ZFXmlTypeEnum")
/**
 * @brief xml item type
 */
 ...
 * serializable data:
 * @code
 *   <ZFXmlVisitTypeEnum value="value">
 *   </ZFXmlVisitTypeEnum>
 * @endcode
 */
#define ZFPropertyTypeId_ZFXmlVisitTypeEnum zfText("ZFXmlVisitTypeEnum")
/**
