...
extern void MD5_Update(MD5_CTX *ctx, const void *data, zfindex size);
extern void MD5_Final(zfbyte *result, MD5_CTX *ctx);
               ...
               ZF_IN_OPT zfbool upperCase /* = zftrue */)
{
    ...
    {
        MD5_Update(&md5Ctx, srcTmp, _ZFP_ZFMd5_blockSize);
        srcTmp += _ZFP_ZFMd5_blockSize;
    }
    if(srcTmp < srcEndTmp)
    {
        MD5_Update(&md5Ctx, srcTmp, srcEndTmp - srcTmp);
    }

    zfbyte result[16] = {0};
    MD5_Final((zfbyte *)result, &md5Ctx);
 ...
 */
static const void *body(MD5_CTX *ctx, const void *data, zfindex size)
{
    const zfbyte *ptr;
    zfuint32 a, b, c, d;
...
void MD5_Update(MD5_CTX *ctx, const void *data, zfindex size)
{
    zfuint32 saved_lo;
...
void MD5_Final(zfbyte *result, MD5_CTX *ctx)
{
    zfindex used, available;
