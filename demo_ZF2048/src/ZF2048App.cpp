...
public:
    ...
    ZFLISTENER_MEMBER_DECLARE(orientationOnChange)
    {
...
public:
    ZFLISTENER_MEMBER_DECLARE(appPaused)
    {
...
public:
    ...
    ZFLISTENER_MEMBER_DECLARE(dataOnChange)
    {
        this->dataUpdate();
    }

public:
    ZFLISTENER_MEMBER_DECLARE(dialogAfterHide)
    {
        this->owner->game()->gameFocus();
    }

    ZFLISTENER_MEMBER_DECLARE(autoMoveOnClick)
    {
    ...
    ZFLISTENER_MEMBER_DECLARE(autoMoveOnStart)
    {
    ...
    ZFLISTENER_MEMBER_DECLARE(autoMoveOnStop)
    {
        this->autoMoveButton()->buttonCheckedSet(zffalse);
    }
    ZFLISTENER_MEMBER_DECLARE(autoMoveStop)
    {
        this->autoMoveRunner()->runnerStop();
    }
    ZFLISTENER_MEMBER_DECLARE(settingOnChange)
    {
    ...
    ZFLISTENER_MEMBER_DECLARE(settingOnClick)
    {
        zfblockedAlloc(ZF2048AppSettingDialog, settingDialog, this->owner->game()->gameDataWidth(), this->owner->game()->gameDataHeight());
        settingDialog->observerAdd(ZF2048AppSettingDialog::EventSettingOnChange(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, settingOnChange)));
        settingDialog->observerAdd(ZF2048AppSettingDialog::EventDialogAfterHide(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, dialogAfterHide)));
...
public:
    ...
    {
        this->autoMoveButton()->observerAdd(ZFUIButton::EventButtonOnClick(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, autoMoveOnClick)));

        this->autoMoveSettingDialog()->observerAdd(ZF2048AppAutoMoveSettingDialog::EventAutoMoveSettingOnChange(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, autoMoveOnStart)));
        this->autoMoveSettingDialog()->observerAdd(ZF2048AppAutoMoveSettingDialog::EventDialogAfterHide(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, dialogAfterHide)));

        this->autoMoveRunner()->game = this->owner->game();
        this->autoMoveRunner()->observerAdd(ZF2048AppAutoMoveRunner::EventRunnerOnStop(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, autoMoveOnStop)));
    ...
    void setupSetting_undo(void)
    {
        ...
        this->undoButton()->observerAdd(ZFUIButton::EventButtonOnClick(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, autoMoveStop)));

        zfLangApplyZFUIButtonBasicTextNormal(this->undoButton(), zfText("ZF2048_undo"));
    }
    void setupSetting_setting(void)
    {
        this->settingButton()->observerAdd(ZFUIButton::EventButtonOnClick(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, settingOnClick)));
        this->settingButton()->observerAdd(ZFUIButton::EventButtonOnClick(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, autoMoveStop)));
    ...
    void setupSetting_about(void)
    {
        ...
        this->aboutButton()->observerAdd(ZFUIButton::EventButtonOnClick(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, autoMoveStop)));
...
public:
    ...
    virtual void objectOnInitFinish(void)
    {
        ...
        this->owner->game()->observerAdd(ZF2048Game::EventGameDataOnChange(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, dataOnChange)));

        ZFGlobalEventCenter::instance()->observerAdd(ZFObject::ObserverAddParam()
                                                     .eventIdSet(ZFUISysWindow::EventSysWindowOnRotate())
                                                     .observerSet(ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, orientationOnChange)))
                                                     .ownerSet(this)
                                                     );

        ZFGlobalEventCenter::instance()->observerAdd(ZFUISysWindow::EventSysWindowOnPause(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, appPaused)));
    ...
    {
        ZFGlobalEventCenter::instance()->observerRemoveByOwner(this);
