...
ZFSTYLE_DEFAULT_DEFINE(ZF2048UIFrameStyle, ZFUIViewStyle)
...
ZFPROPERTY_OVERRIDE_SETTER_DEFINE(ZF2048UIFrame, ZFUIImage *, frameBackgroundImage)
{
    zfsuperI(ZF2048UIFrameStyle)::frameBackgroundImageSet(newValue);
    d->backgroundView->imageContentSet(this->frameBackgroundImage());
}
ZFPROPERTY_OVERRIDE_SETTER_DEFINE(ZF2048UIFrame, ZFUIMargin, frameMargin)
{
    zfsuperI(ZF2048UIFrameStyle)::frameMarginSet(newValue);
    this->layoutRequest();
}
...
ZF_GLOBAL_INITIALIZER_INIT(ZF2048UIFrameDisableFocusAutoHighlight)
{
    ZFUIViewFocusAutoHighlightFilter.classFilter.filterAdd(ZF2048UIFrame::ClassData());
}
ZF_GLOBAL_INITIALIZER_END(ZF2048UIFrameDisableFocusAutoHighlight)
