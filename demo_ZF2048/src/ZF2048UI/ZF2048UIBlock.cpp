...
ZFSTYLE_DEFAULT_DEFINE(ZF2048UIBlockStyle, ZFUIImageViewStyle)

ZFOBJECT_REGISTER(ZF2048UIBlock)
ZFCACHEABLE_DEFINE_WITH_MAX(ZF2048UIBlock, ZF2048UIBlock, 16)

ZFPROPERTY_OVERRIDE_SETTER_DEFINE(ZF2048UIBlock, ZF2048Value, blockValue)
{
    zfsuperI(ZF2048UIBlockStyle)::blockValueSet(newValue);
