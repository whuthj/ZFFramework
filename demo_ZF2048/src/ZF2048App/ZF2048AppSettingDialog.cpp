...
private:
    void loadContent(void)
    {
        ...
        { // load from xml
            ...
            ZFSerializableData data = ZFSerializableDataParseXml(input);
        ...
        { // load by code
...

            {
                ...
                zfblockedAlloc(ZFUITextEdit, dataWidthEditTmp);
            ...
            }
            {
                ...
                zfblockedAlloc(ZFUITextEdit, dataHeightEditTmp);
    ...
    void prepareLogic(void)
    {
        ...
        this->confirmButton->observerAdd(ZFUIButton::EventButtonOnClick(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, confirmOnClick)));
        this->cancelButton->observerAdd(ZFUIButton::EventButtonOnClick(), ZFCallbackForMemberMethod(this, ZFMethodAccessClassMember(zfself, cancelOnClick)));
    }
    ZFLISTENER_MEMBER_DECLARE(confirmOnClick)
    {
    ...
    ZFLISTENER_MEMBER_DECLARE(cancelOnClick)
    {
        this->owner->dialogHide();
    }
};
